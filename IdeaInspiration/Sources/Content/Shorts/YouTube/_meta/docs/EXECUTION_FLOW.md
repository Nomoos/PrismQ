...
> **Note**: This document references the Web Client module which has been moved to a separate repository.
> The content is preserved for historical context. See [CLIENT_MIGRATION.md](../../../../../_meta/docs/CLIENT_MIGRATION.md) for details.
