...
class InstagramHashtagPlugin(SourcePlugin):
    ...
    def scrape_hashtag(self, hashtag: str, max_reels: Optional[int] = None) -> List[IdeaInspiration]:
    ...
    def scrape(self, hashtag: Optional[str] = None, max_reels: Optional[int] = None) -> List[IdeaInspiration]:
        """Main scrape method.
