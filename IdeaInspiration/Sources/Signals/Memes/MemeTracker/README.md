...
MemeTrackerSource tracks meme propagation and virality across multiple platforms. This source is part of the PrismQ.IdeaInspiration ecosystem and provides insights into meme trends and their evolution.

## Features

- ✅ Tracks meme propagation across platforms
- ✅ Identifies meme origins and spread patterns
...
cd Sources/Signals/Memes/MemeTracker
...
- `DATABASE_PATH` - Path to SQLite database (default: `signals_meme_tracker.db`)
...
### Production Mode
Scrapes from configured platforms
...
│       └── meme_tracker_plugin.py  # Meme tracking implementation
├── tests/                          # Test suite
