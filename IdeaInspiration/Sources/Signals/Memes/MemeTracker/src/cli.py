...
def scrape(env_file, keywords, no_interactive):
    ...
    try:
        ...
        try:
            trends_plugin = MemeTrackerPlugin(config)
        ...
        click.echo(f"Region: {config.meme_tracker_region}")
        click.echo(f"Timeframe: {config.meme_tracker_timeframe}")
        if keywords:
        ...
        try:
            ...
            for signal in signals:
                ...
                universal_metrics = UniversalMetrics.from_meme_tracker(signal['metrics'])
