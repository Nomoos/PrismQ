...
def test_from_news_api_basic():
    ...
    um = UniversalMetrics.from_news_api(metrics)
...
def test_trend_strength_calculation():
    ...
    um_high = UniversalMetrics.from_news_api(high_volume_metrics)
    ...
    um_low = UniversalMetrics.from_news_api(low_volume_metrics)
...
def test_virality_score_calculation():
    ...
    um_viral = UniversalMetrics.from_news_api(high_velocity_metrics)
    ...
    um_flat = UniversalMetrics.from_news_api(zero_velocity_metrics)
...
def test_max_values_capped():
    ...
    um = UniversalMetrics.from_news_api(extreme_metrics)
