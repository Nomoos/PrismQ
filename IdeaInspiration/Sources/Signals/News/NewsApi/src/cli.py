...
def scrape(env_file, keywords, no_interactive):
    ...
    try:
        ...
        try:
            trends_plugin = NewsApiPlugin(config)
        ...
        click.echo(f"Region: {config.news_api_region}")
        click.echo(f"Timeframe: {config.news_api_timeframe}")
        if keywords:
        ...
        try:
            ...
            for signal in signals:
                ...
                universal_metrics = UniversalMetrics.from_news_api(signal['metrics'])
