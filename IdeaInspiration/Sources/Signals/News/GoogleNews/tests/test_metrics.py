...
def test_from_google_news_basic():
    ...
    um = UniversalMetrics.from_google_news(metrics)
...
def test_trend_strength_calculation():
    ...
    um_high = UniversalMetrics.from_google_news(high_volume_metrics)
    ...
    um_low = UniversalMetrics.from_google_news(low_volume_metrics)
...
def test_virality_score_calculation():
    ...
    um_viral = UniversalMetrics.from_google_news(high_velocity_metrics)
    ...
    um_flat = UniversalMetrics.from_google_news(zero_velocity_metrics)
...
def test_max_values_capped():
    ...
    um = UniversalMetrics.from_google_news(extreme_metrics)
