...
def test_from_tik_tok_sounds_basic():
    ...
    um = UniversalMetrics.from_tik_tok_sounds(metrics)
...
def test_trend_strength_calculation():
    ...
    um_high = UniversalMetrics.from_tik_tok_sounds(high_volume_metrics)
    ...
    um_low = UniversalMetrics.from_tik_tok_sounds(low_volume_metrics)
...
def test_virality_score_calculation():
    ...
    um_viral = UniversalMetrics.from_tik_tok_sounds(high_velocity_metrics)
    ...
    um_flat = UniversalMetrics.from_tik_tok_sounds(zero_velocity_metrics)
...
def test_max_values_capped():
    ...
    um = UniversalMetrics.from_tik_tok_sounds(extreme_metrics)
