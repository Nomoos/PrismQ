...
class UniversalMetrics:
    ...
    @classmethod
    def from_location(cls, metrics: Dict[str, Any]) -> 'UniversalMetrics':
        """Create universal metrics from location data.
        
        Args:
            metrics: Location metrics dictionary
        ...
        spread_score = metrics.get('spread_score', 0.0)
