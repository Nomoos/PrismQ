...
InstagramHashtagSource collects hashtag signals from Instagram to identify viral trends and popular topics. This source is part of the PrismQ.IdeaInspiration ecosystem and provides early indicators of trending content on Instagram.

## Features

- ✅ Collects trending Instagram hashtags
- ✅ Tracks hashtag usage counts and engagement metrics
...
cd Sources/Signals/Hashtags/InstagramHashtag
...
- `DATABASE_PATH` - Path to SQLite database (default: `signals_instagram_hashtag.db`)
...
python -m src.cli scrape --hashtags "reels,viral,trending"
```
...
│       └── instagram_hashtag_plugin.py  # Instagram implementation
├── tests/                          # Test suite
