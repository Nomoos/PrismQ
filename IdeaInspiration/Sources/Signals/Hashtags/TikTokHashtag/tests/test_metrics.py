...
def test_from_tik_tok_hashtag_basic():
    ...
    um = UniversalMetrics.from_tik_tok_hashtag(metrics)
...
def test_trend_strength_calculation():
    ...
    um_high = UniversalMetrics.from_tik_tok_hashtag(high_volume_metrics)
    ...
    um_low = UniversalMetrics.from_tik_tok_hashtag(low_volume_metrics)
...
def test_virality_score_calculation():
    ...
    um_viral = UniversalMetrics.from_tik_tok_hashtag(high_velocity_metrics)
    ...
    um_flat = UniversalMetrics.from_tik_tok_hashtag(zero_velocity_metrics)
...
def test_max_values_capped():
    ...
    um = UniversalMetrics.from_tik_tok_hashtag(extreme_metrics)
