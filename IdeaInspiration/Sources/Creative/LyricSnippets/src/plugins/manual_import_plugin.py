"""Manual import plugin for curated lyric snippets."""
...
class ManualImportPlugin(SourcePlugin):
    """Plugin for manually importing curated lyric snippets."""
    ...
    def import_from_json(self, file_path: str) -> List[Dict[str, Any]]:
        """Import lyric snippets from JSON file.
        
        Args:
            file_path: Path to JSON file
            
        Returns:
            List of lyric snippet dictionaries
    ...
    def import_from_csv(self, file_path: str) -> List[Dict[str, Any]]:
        """Import lyric snippets from CSV file.
