...
This module provides a builder pattern for constructing IdeaInspiration-compatible
dictionaries step-by-step with validation and enrichment.

Note: IdeaInspiration model is defined externally. This builder returns dictionaries
...
class IdeaInspirationBuilder:
    """Builder for constructing IdeaInspiration-compatible dictionaries.
    
    This class provides a fluent interface for building dictionaries compatible
    with external IdeaInspiration model, with validation and optional enrichment.
    
    Example:
        builder = IdeaInspirationBuilder()
        inspiration_dict = (builder
            .set_title("My Story")
    ...
    def build(self) -> IdeaInspirationDict:
        """Build and return a dictionary compatible with IdeaInspiration model.
        
        Returns:
            Dictionary with IdeaInspiration-compatible fields
        ...
        if not self.validate():
            raise ValueError(
                "Cannot build IdeaInspiration dict: must have at least a title, "
