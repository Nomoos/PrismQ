@echo off
REM PrismQ Add Repository with Submodule - Python Environment Setup Script
REM Sets up Python virtual environment for the add-repo-with-submodule script

setlocal enabledelayedexpansion

echo.
echo ========================================================
echo   PrismQ Add Repository with Submodule - Setup
echo ========================================================
echo.
...
py --version >nul 2>&1
if errorlevel 1 (
    echo Error: Python is not installed or not available via py launcher
...
if exist "%VENV_DIR%" (
    ...
    for /f "tokens=2" %%i in ('py --version 2^>^&1') do set SYSTEM_PY_VER=%%i
