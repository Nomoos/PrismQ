...
class StoryState(str, Enum):
    ...
    CONTENT_FROM_IDEA_TITLE = f"{_STATE_PREFIX}.Content.From.Idea.Title"

    # Stages 4-6: Initial Review Cycle
    REVIEW_TITLE_FROM_CONTENT_IDEA = f"{_STATE_PREFIX}.Review.Title.From.Content.Idea"
    REVIEW_CONTENT_FROM_TITLE_IDEA = f"{_STATE_PREFIX}.Review.Content.From.Title.Idea"
    REVIEW_TITLE_FROM_CONTENT = f"{_STATE_PREFIX}.Review.Title.From.Content"
    ...
    TITLE_FROM_CONTENT_REVIEW_TITLE = f"{_STATE_PREFIX}.Title.From.Content.Review.Title"

    # Stages 10-16: Quality Review States
    REVIEW_CONTENT_GRAMMAR = f"{_STATE_PREFIX}.Review.Content.Grammar"
    REVIEW_CONTENT_TONE = f"{_STATE_PREFIX}.Review.Content.Tone"
    REVIEW_CONTENT_CONTENT = f"{_STATE_PREFIX}.Review.Content.Content"
    REVIEW_CONTENT_CONSISTENCY = f"{_STATE_PREFIX}.Review.Content.Consistency"
    REVIEW_CONTENT_EDITING = f"{_STATE_PREFIX}.Review.Content.Editing"
    ...
    CONTENT_V0 = f"{_STATE_PREFIX}.Content.V0"
...
class StateNames:
    ...
    CONTENT_FROM_IDEA_TITLE = f"{STATE_PREFIX}.Content.From.Idea.Title"

    # =========================================================================
    # Stages 4-6: Initial Review Cycle
    # =========================================================================
    REVIEW_TITLE_FROM_CONTENT_IDEA = f"{STATE_PREFIX}.Review.Title.From.Content.Idea"
    REVIEW_CONTENT_FROM_TITLE_IDEA = f"{STATE_PREFIX}.Review.Content.From.Title.Idea"
    REVIEW_TITLE_FROM_CONTENT = f"{STATE_PREFIX}.Review.Title.From.Content"
    ...
    TITLE_FROM_CONTENT_REVIEW_TITLE = f"{STATE_PREFIX}.Title.From.Content.Review.Title"
    CONTENT_FROM_TITLE_REVIEW_CONTENT = f"{STATE_PREFIX}.Content.From.Title.Review.Content"

    # =========================================================================
    # Stages 10-16: Quality Review States
    # =========================================================================
    REVIEW_CONTENT_GRAMMAR = f"{STATE_PREFIX}.Review.Content.Grammar"
    REVIEW_CONTENT_TONE = f"{STATE_PREFIX}.Review.Content.Tone"
    REVIEW_CONTENT_CONTENT = f"{STATE_PREFIX}.Review.Content.Content"
    REVIEW_CONTENT_CONSISTENCY = f"{STATE_PREFIX}.Review.Content.Consistency"
    REVIEW_CONTENT_EDITING = f"{STATE_PREFIX}.Review.Content.Editing"
    ...
    _CATEGORY_MAPPINGS: Dict[StateCategory, List[str]] = {
        ...
        StateCategory.REVIEW: [
            ...
            REVIEW_TITLE_FROM_CONTENT,
            REVIEW_CONTENT_FROM_TITLE,
    ...
    def get_states_by_category(cls, category: StateCategory) -> List[str]:
        ...
        Example:
            ...
            >>> 'PrismQ.T.Review.Content.Grammar' in review_states
            True
        """
    ...
    def get_quality_review_states(cls) -> List[str]:
        ...
        """
        return [
            cls.REVIEW_CONTENT_GRAMMAR,
            cls.REVIEW_CONTENT_TONE,
            cls.REVIEW_CONTENT_CONTENT,
            cls.REVIEW_CONTENT_CONSISTENCY,
            cls.REVIEW_CONTENT_EDITING,
            cls.REVIEW_TITLE_READABILITY,
            cls.REVIEW_CONTENT_READABILITY,
        ]
