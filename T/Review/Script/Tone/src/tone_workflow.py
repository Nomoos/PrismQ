#!/usr/bin/env python3
"""Continuous Workflow Runner for PrismQ.T.Review.Content.Tone

This script runs continuously, processing Story objects that need tone review.
...
Usage:
    python tone_workflow.py           # Run continuously with DB save
    python tone_workflow.py --preview # Preview mode (no DB save)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Continuous Tone Review Workflow for PrismQ"
    )
    ...
    print_header("PrismQ.T.Review.Content.Tone - CONTINUOUS MODE")
