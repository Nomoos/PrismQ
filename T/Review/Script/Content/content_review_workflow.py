#!/usr/bin/env python3
"""Continuous Workflow Runner for PrismQ.T.Review.Content.Content
...
Usage:
    python content_review_workflow.py           # Run continuously with DB save
    python content_review_workflow.py --preview # Preview mode (no DB save)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Continuous Content Review Workflow for PrismQ"
    )
    ...
    print_header("PrismQ.T.Review.Content.Content - CONTINUOUS MODE")
    ...
    try:
        while True:
            ...
            print_success(f"Found {pending_count} stories ready for content review")
