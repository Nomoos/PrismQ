...
class TestReadabilityReviewBasic:
    ...
    def test_create_failing_review(self):
        ...
        review = ReadabilityReview(
            ...
            script_version="v3",
            overall_score=75  # Below threshold of 85
        )
...
class TestScriptReadabilityChecker:
    ...
    def test_tongue_twister_detected(self):
        ...
        twister_issues = [i for i in review.issues if i.issue_type == ReadabilityIssueType.TONGUE_TWISTER]
    ...
    def test_complex_words_detected(self):
        ...
        mouthfeel_issues = [i for i in review.issues if i.issue_type == ReadabilityIssueType.MOUTHFEEL]
    ...
    def test_critical_issue_fails_review(self):
        ...
        review = ReadabilityReview(
            script_id="script-critical",
            script_version="v3",
            overall_score=90  # Good score but...
        )
