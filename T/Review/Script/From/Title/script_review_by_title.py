...
Workflow Position:
    Idea + Title v1 → Script v1 → ByTitle Review → Feedback/Approval
"""
...
def review_script_by_title(
    ...
    overall_score = _calculate_overall_score(
        title_alignment.score,
        idea_alignment.score,
        content_scores
    )
    ...
    review = ScriptReview(
        ...
        is_youtube_short=(target_length in [
        ...
        primary_concern=_identify_primary_concern(
            title_alignment,
            idea_alignment,
            content_scores
        ),
