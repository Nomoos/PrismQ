...
from T.Review.Script.script_review import ContentLength, ReviewCategory
...
class TestReviewScriptByTitleV2:
    ...
    def test_basic_v2_review(self, script_v2, title_v3, sample_idea):
        ...
        review = review_script_by_title_v2(script_text=script_v2, title=title_v3, idea=sample_idea)
    ...
    def test_v2_review_with_previous_review(
        ...
        v2_review = review_script_by_title_v2(
            script_text=script_v2, title=title_v3, idea=sample_idea, previous_review=v1_review
        )
    ...
    def test_v2_review_without_previous_review(self, script_v2, title_v3, sample_idea):
        ...
        review = review_script_by_title_v2(
            script_text=script_v2, title=title_v3, idea=sample_idea, previous_review=None
        )
    ...
    def test_v2_review_generates_version_specific_script_id(self, script_v2, title_v3, sample_idea):
        ...
        review = review_script_by_title_v2(
            script_text=script_v2, title=title_v3, idea=sample_idea, script_version="v2"
        )
    ...
    def test_v2_review_with_target_length(self, script_v2, title_v3, sample_idea):
        ...
        review = review_script_by_title_v2(
            script_text=script_v2, title=title_v3, idea=sample_idea, target_length_seconds=60
        )
...
class TestComparisonMetadata:
    ...
    def test_regression_warnings_in_improvement_points(self, sample_idea):
        ...
        v2_review = review_script_by_title_v2(
            poor_script, "Title", sample_idea, previous_review=v1_review
        )
