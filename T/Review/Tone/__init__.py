...
DEPRECATED: This module is deprecated. Import from T.Review.Script.Tone instead:
    from T.Review.Script.Tone import ToneReview, ToneIssue, ToneIssueType, ToneSeverity
"""
