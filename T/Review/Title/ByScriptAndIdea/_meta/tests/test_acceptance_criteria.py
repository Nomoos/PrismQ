...
class TestAcceptanceCriteria:
    ...
    def test_ac3_identify_mismatches(self):
        ...
        script_alignment_issues = [
            imp for imp in review.improvement_points
        ...
        assert any(
            "alignment" in imp.description.lower() or 
            "script" in imp.description.lower() or
            "match" in imp.description.lower() or
            "reflect" in imp.description.lower()
    ...
    def test_ac6_sample_title_script_pairs(self):
        ...
        review1 = review_title_by_script_and_idea(
            title_text=sample1['title'],
            script_text=sample1['script'],
            idea_summary=sample1['idea']
        )
        ...
        review2 = review_title_by_script_and_idea(
            title_text=sample2['title'],
            script_text=sample2['script'],
            idea_summary=sample2['idea']
        )
        ...
        review3 = review_title_by_script_and_idea(
            title_text=sample3['title'],
            script_text=sample3['script'],
            idea_summary=sample3['idea']
        )
