...
class TestReviewTitleByScriptAndIdea:
    ...
    def test_review_to_dict_compatibility(self):
        ...
        review = review_title_by_script_and_idea(
            title_text="The Echo",
            script_text="Story about echoes",
            idea_summary="Echo story"
        )
    ...
    def test_very_long_title(self):
        ...
        review = review_title_by_script_and_idea(
            ...
            idea_summary="Some idea"
        )
        
        # Should have improvement point about length
        assert any(
            imp.category == TitleReviewCategory.CLARITY
...
class TestWorkflowIntegration:
    ...
    def test_iterative_improvement_tracking(self):
        ...
        review = review_title_by_script_and_idea(
            title_text="The Echo",
            script_text="Echo story",
            idea_summary="Echo idea"
        )
