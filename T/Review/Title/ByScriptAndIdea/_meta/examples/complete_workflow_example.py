...
def example_complete_workflow():
    ...
    idea_summary = "Horror mystery about mysterious echoes in an abandoned house that reveal secrets"
    ...
    print(f"Status: {'✓ APPROVED' if review.overall_score >= 80 else '⚠ NEEDS IMPROVEMENT' if review.overall_score >= 65 else '✗ MAJOR REVISION NEEDED'}")
    ...
    print(f"Ready for Publication: {'✓ Yes' if engagement['ready_for_publication'] else '✗ Not yet'}")
...
def example_comparison():
    ...
    titles = [
        "The Echo",
        "Echoes of the Past",
        "The Haunting Echo - Secrets Revealed"
    ]
    ...
    for title, review in results:
        print(f"{title:<40} {review.overall_score:<8} {review.script_alignment_score:<8} "
