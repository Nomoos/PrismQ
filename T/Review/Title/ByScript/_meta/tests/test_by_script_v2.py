...
from T.Review.Title.ByScriptAndIdea.by_script_and_idea import review_title_by_script_and_idea
...
class TestReviewTitleByScriptV2:
    ...
    def test_v2_review_improvement_points_sorted(self, sample_v2_title, sample_v2_script):
        ...
        poor_title = "Video"
        review = review_title_by_script_v2(
            title_text=poor_title,
            script_text=sample_v2_script
        )
        
        if len(review.improvement_points) > 1:
            for i in range(len(review.improvement_points) - 1):
                assert review.improvement_points[i].impact_score >= review.improvement_points[i + 1].impact_score
...
class TestCompareReviews:
    ...
    def test_compare_detects_improvement(self, sample_v1_title, sample_v1_script, 
                                        sample_v2_title, sample_v2_script, sample_idea):
...
class TestWorkflowIntegration:
    ...
    def test_v1_to_v2_workflow(self, sample_v1_title, sample_v1_script, 
                               sample_v2_title, sample_v2_script, sample_idea):
    ...
    def test_multiple_iterations(self, sample_v1_title, sample_v1_script,
                                sample_v2_title, sample_v2_script, sample_idea):
