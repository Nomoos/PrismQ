...
class TitleReviewCategory(Enum):
    ...
    CONTENT_ALIGNMENT = "content_alignment"  # Title matches content
...
class TitleReview:
    ...
    def get_alignment_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "key_issues": [
                imp.title
                for imp in self.get_high_priority_improvements()
                if imp.category
                in [TitleReviewCategory.CONTENT_ALIGNMENT, TitleReviewCategory.IDEA_ALIGNMENT]
            ],
        }
    ...
    def get_engagement_summary(self) -> Dict[str, Any]:
        ...
        ready_for_publication = (
            composite_engagement >= 70
            and self.expectation_accuracy >= 65
            and self.overall_score >= 75
        )
    ...
    def is_ready_for_improvement(self) -> bool:
        ...
        alignment_assessed = self.script_alignment_score > 0 or self.idea_alignment_score > 0
