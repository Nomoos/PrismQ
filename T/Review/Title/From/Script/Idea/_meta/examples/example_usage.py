...
def example_complete_review():
    ...
    review.category_scores.append(TitleCategoryScore(
        ...
        weaknesses=[
            "Could be more specific about setting",
            "Subtitle is somewhat generic"
        ]
    ))
    ...
    review.category_scores.append(TitleCategoryScore(
        ...
        weaknesses=[
            "Could better hint at specific horror elements"
        ]
    ))
    ...
    review.primary_concern = "Subtitle is generic and doesn't fully capture the unique elements of the script"
