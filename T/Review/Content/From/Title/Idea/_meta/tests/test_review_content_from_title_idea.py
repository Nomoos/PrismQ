...
REPO_ROOT = Path(__file__).parent.parent.parent.parent.parent.parent.parent.parent.parent
...
from review_content_from_title_idea import (
    AlignmentScore,
...
class TestReviewContentFromTitleIdea:
    ...
    def test_review_generates_default_content_id(self):
        ...
        review = review_content_from_title_idea("Test script", "Test Title", idea)
...
class TestAlignmentAnalysis:
    ...
    def test_idea_alignment_with_concept(self):
        ...
        review = review_content_from_title_idea(script, "The Future Seer", idea)
    ...
    def test_idea_alignment_with_genre(self):
        ...
        review = review_content_from_title_idea(script, "The Dark", idea)
...
class TestContentScoring:
    ...
    def test_engagement_score_with_strong_opening(self):
        ...
        review = review_content_from_title_idea(script, "Test", idea)
...
class TestImprovementGeneration:
    ...
    def test_generates_improvements_for_low_scores(self):
        ...
        review = review_content_from_title_idea(script, "Understanding Quantum", idea)
    ...
    def test_quick_wins_identified(self):
        ...
        review = review_content_from_title_idea(script, "Different Title", idea)
...
class TestTargetLengthDetermination:
    ...
    def test_determines_youtube_short_from_idea_length_target(self):
        ...
        review = review_content_from_title_idea("Test", "Test", idea)
    ...
    def test_determines_youtube_short_from_target_seconds(self):
        ...
        review = review_content_from_title_idea("Test", "Test", idea, target_length_seconds=55)
    ...
    def test_determines_short_form_for_longer_content(self):
        ...
        review = review_content_from_title_idea("Test", "Test", idea, target_length_seconds=240)
...
class TestMetadataAndTracking:
    ...
    def test_tracks_strengths_from_alignment(self):
        ...
        review = review_content_from_title_idea(script, "System Test", idea)
    ...
    def test_identifies_primary_concern(self):
        ...
        review = review_content_from_title_idea(script, "Expert Guide", idea)
...
class TestEdgeCases:
    ...
    def test_handles_empty_content(self):
        ...
        review = review_content_from_title_idea("", "Test", idea)
    ...
    def test_handles_very_long_content(self):
        ...
        review = review_content_from_title_idea(long_content, "Test", idea)
    ...
    def test_handles_minimal_idea(self):
        ...
        review = review_content_from_title_idea("Some script content", "Title", idea)
