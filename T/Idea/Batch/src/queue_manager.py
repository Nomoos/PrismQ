...
class QueueManager:
    ...
    def mark_chunk_processed(self, results: List[Dict[str, Any]]) -> None:
    ...
    def get_progress(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "progress_percentage": (
                (self.processed_count / self.total_items * 100) if self.total_items > 0 else 0.0
            ),
    ...
    async def process_queue(
        self, process_chunk_func, max_concurrent: int = 5
    ) -> List[Dict[str, Any]]:
