...
class YouTubeAdapter:
    ...
    def to_idea_inspiration(self) -> IdeaInspiration:
        ...
        return IdeaInspiration(
            id=self._api_response.videoId, title=self._api_response.videoTitle, source="youtube"
        )
...
def demonstrate_patterns():
    ...
    api_response = YouTubeAPIResponse(video_id="yt-789", video_title="Awesome Video")
