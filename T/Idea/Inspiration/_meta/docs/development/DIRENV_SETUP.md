...
- [Virtual Environment Strategy](./VIRTUAL_ENVIRONMENTS.md)
- [Issue #118: direnv Implementation](../../issues/done/118-implement-direnv.md)
- [Issue #115: Per-Project venv](../../issues/done/115-implement-per-project-venv.md)
