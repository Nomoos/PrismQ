...
class HackerNewsStoryWorker(BaseWorker):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.hn_client = HackerNewsClient(timeout=10, rate_limit_delay=0.1)
    ...
    def process_task(self, task: Task) -> TaskResult:
        ...
        try:
            ...
            logger.info(f"Fetching {limit} {story_type} stories from HackerNews")
    ...
    def _store_stories(self, stories: list, story_type: str):
        ...
        from core.idea_processor import ContentType, IdeaProcessor
