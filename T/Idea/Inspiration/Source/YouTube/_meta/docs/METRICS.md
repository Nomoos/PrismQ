...
PrismQ.T.Idea.Inspiration.Sources.Content.Shorts.YouTubeShortsSource uses a **universal metrics schema** that standardizes data collection from YouTube Shorts. This schema is designed to be compatible with other PrismQ Idea Sources modules for cross-platform analysis:
...
- `PrismQ.T.Idea.Inspiration.Sources.Content.Forums.RedditSource` - Reddit posts
- `PrismQ.T.Idea.Inspiration.Sources.Content.Shorts.TikTokSource` - TikTok videos
- `PrismQ.T.Idea.Inspiration.Sources.Content.Shorts.InstagramReelsSource` - Instagram Reels
- etc.
...
1. Create a new repository (e.g., `PrismQ.T.Idea.Inspiration.Sources.Content.Shorts.TikTokSource`)
