...
def register_task_types():
    ...
    for task_type_def in task_types:
        try:
            ...
            logger.info(
                f"Task type '{task_type_def['name']}' {status} (ID: {task_type_id})"
            )
    ...
    class YouTubeChannelWorker(BaseWorker):
        ...
        def process_task(self, task: Task) -> TaskResult:
            ...
            try:
                ...
                logger.info(
                    f"Processing channel scrape: {channel_url} "
    ...
    for channel_url in channels:
        try:
            ...
            logger.info(
                ...
                f"Duplicate={task.get('duplicate', False)}"
            )
