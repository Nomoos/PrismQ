...
class YouTubeAPIClient:
    ...
    def __init__(
        ...
        self.rate_limiter = RateLimiter(requests_per_minute=rate_limit, quota_per_day=quota_per_day)
    ...
    def get_playlist_items(
        self, playlist_id: str, max_results: int = 50, page_token: Optional[str] = None
    ) -> Dict[str, Any]:
        ...
        return self._make_request(
            "playlistItems", params, quota_cost=self.QUOTA_COSTS["playlistItems"]
        )
