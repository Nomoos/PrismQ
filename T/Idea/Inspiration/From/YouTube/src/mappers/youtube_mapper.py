...
class YouTubeMapper:
    ...
    def to_video_metadata_dict(self, youtube_video: YouTubeVideo) -> Dict[str, Any]:
        ...
        # Get best thumbnail
        thumbnail_url = (
            youtube_video.thumbnails.get("maxres")
            or youtube_video.thumbnails.get("high")
            or youtube_video.thumbnails.get("medium")
            or youtube_video.thumbnails.get("default")
            or ""
        )
        ...
        return {
            ...
            "channel_url": (
                f"https://www.youtube.com/channel/{youtube_video.channel_id}"
                if youtube_video.channel_id
                else None
            ),
