...
class YouTubeTrendingPlugin(SourcePlugin):
    ...
    def scrape_trending(
        self, top_n: Optional[int] = None, category: str = "all"
    ) -> List[Dict[str, Any]]:
    ...
    def scrape(
        self, keyword: Optional[str] = None, trending: bool = False, top_n: Optional[int] = None
    ) -> List[Dict[str, Any]]:
    ...
    def _search_by_keyword(self, keyword: str, top_n: int) -> List[str]:
        ...
        cmd = ["yt-dlp", "--flat-playlist", "--print", "id", search_query]
    ...
    def _extract_video_metadata(self, video_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            print(
                f"    ✓ Video accepted: {duration_seconds}s, {width}x{height}, shorts_url={is_shorts_url}"
            )
