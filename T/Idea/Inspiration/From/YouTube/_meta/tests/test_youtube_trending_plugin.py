...
class TestExtractTags:
    ...
    def test_extract_tags_with_uploader(self):
        ...
        with patch.object(YouTubeTrendingPlugin, "_check_ytdlp", return_value=True):
            ...
            metadata = {"uploader": "UploaderName", "tags": []}
    ...
    def test_extract_tags_with_categories(self):
        ...
        with patch.object(YouTubeTrendingPlugin, "_check_ytdlp", return_value=True):
            ...
            metadata = {"categories": ["Gaming", "Technology"], "tags": []}
    ...
    def test_extract_tags_limits_video_tags(self):
        ...
        with patch.object(YouTubeTrendingPlugin, "_check_ytdlp", return_value=True):
            ...
            metadata = {"tags": ["tag1", "tag2", "tag3", "tag4", "tag5", "tag6", "tag7"]}
...
class TestMetadataToIdea:
    ...
    def test_metadata_to_idea_without_subtitle(self):
        ...
        with patch.object(YouTubeTrendingPlugin, "_check_ytdlp", return_value=True):
            ...
            metadata = {"id": "test123", "title": "Test Video", "view_count": 100, "duration": 60}
        ...
        with patch.object(YouTubeTrendingPlugin, "_check_ytdlp", return_value=True):
            ...
            with patch.object(plugin, "_get_trending_videos", return_value=["vid1", "vid2"]):
                with patch.object(
                    ...
                    return_value={"id": "vid1", "title": "Test", "view_count": 100, "duration": 60},
                ):
                    with patch.object(
                        plugin,
                        "_metadata_to_idea",
                        return_value={"source_id": "vid1", "title": "Test", "metrics": {}},
                    ):
                ...
                with patch("pathlib.Path.exists", return_value=True):
                    with patch("builtins.open", create=True) as mock_open:
                        ...
                        mock_open.return_value.__enter__.return_value.read.return_value = (
                            json.dumps({"id": "long_vid", "duration": 300})  # 5 minutes - too long
                        )
