...
class TestYouTubeConfigInitialization:
    ...
    def test_initialization_with_custom_values(self):
        ...
        config = YouTubeConfig(
            api_key="test_key", rate_limit=50, quota_per_day=5000, max_retries=5, timeout=60
        )
...
class TestYouTubeConfigFromDict:
    ...
    def test_from_dict_basic(self):
        ...
        config_dict = {"api_key": "dict_key", "rate_limit": 75, "quota_per_day": 8000}
    ...
    def test_from_dict_extra_keys(self):
        ...
        config_dict = {"api_key": "dict_key", "extra_key": "should_be_ignored"}
...
class TestYouTubeConfigToDict:
    ...
    def test_to_dict(self):
        ...
        config = YouTubeConfig(api_key="test_key", rate_limit=50, quota_per_day=5000)
...
class TestYouTubeConfigRepresentation:
    ...
    def test_repr_shows_other_values(self):
        ...
        config = YouTubeConfig(api_key="test_key", rate_limit=75, quota_per_day=8000)
