...
from src.schemas import YouTubeChannel, YouTubeSearchResult, YouTubeVideo
...
def sample_video_response():
    ...
    return {
        ...
        "contentDetails": {"duration": "PT5M30S", "caption": "true", "definition": "hd"},
...
class TestParseChannel:
    ...
    def test_parse_channel(self, mapper):
        ...
        response = {
            ...
            "statistics": {"subscriberCount": "10000", "videoCount": "500", "viewCount": "1000000"},
