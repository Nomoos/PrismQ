...
from src.core.idea_processor import ContentType, IdeaInspiration, IdeaProcessor
...
class TestIdeaProcessorBasic:
    ...
    def test_process_with_description(self):
        ...
        record = MockYouTubeShortsRecord(
            title="Test Title", source_id="abc123", description="This is a test description"
        )
    ...
    def test_process_with_tags(self):
        ...
        record = MockYouTubeShortsRecord(
            title="Test Title", source_id="abc123", tags="python, programming, tutorial"
        )
    ...
    def test_process_with_empty_tags(self):
        ...
        record = MockYouTubeShortsRecord(title="Test Title", source_id="abc123", tags="")
    ...
    def test_process_with_score(self):
        ...
        record = MockYouTubeShortsRecord(title="Test Title", source_id="abc123", score=85.7)
...
class TestIdeaProcessorWithMetadata:
    ...
    def test_process_with_subtitle_text(self):
        ...
        record = MockYouTubeShortsRecord(
            title="Test Title", source_id="abc123", score_dictionary=json.dumps(score_dict)
        )
    ...
    def test_process_with_content_details(self):
        ...
        score_dict = {"contentDetails": {"duration": "PT45S"}}
...
class TestIdeaProcessorComprehensive:
    ...
    def test_to_dict_conversion(self):
        ...
        record = MockYouTubeShortsRecord(title="Test Title", source_id="abc123", tags="tag1, tag2")
...
class TestIdeaProcessorEdgeCases:
    ...
    def test_process_record_without_title(self):
        ...
        record = MockYouTubeShortsRecord(title="", source_id="abc123")
    ...
    def test_process_record_without_source_id(self):
        ...
        record = MockYouTubeShortsRecord(title="Test Title", source_id="")
    ...
    def test_process_with_none_score_dictionary(self):
        ...
        record = MockYouTubeShortsRecord(
            title="Test Title", source_id="abc123", score_dictionary=None
        )
    ...
    def test_process_with_empty_score_dictionary(self):
        ...
        record = MockYouTubeShortsRecord(
            title="Test Title", source_id="abc123", score_dictionary=json.dumps({})
        )
    ...
    def test_extract_upload_date_yyyymmdd_format(self):
        ...
        score_dict = {"snippet": {"publishedAt": "20241015"}}
    ...
    def test_extract_upload_date_iso8601_format(self):
        ...
        score_dict = {"snippet": {"publishedAt": "2024-10-15T10:30:00Z"}}
...
class TestIdeaProcessorBatch:
    ...
    def test_process_batch_single_record(self):
        ...
        records = [MockYouTubeShortsRecord(title="Test 1", source_id="abc123")]
    ...
    def test_process_batch_multiple_records(self):
        ...
        records = [
            MockYouTubeShortsRecord(title="Test 1", source_id="abc123"),
            MockYouTubeShortsRecord(title="Test 2", source_id="def456"),
            MockYouTubeShortsRecord(title="Test 3", source_id="ghi789"),
        ]
    ...
    def test_process_batch_with_invalid_record(self):
        ...
        records = [
            MockYouTubeShortsRecord(title="Test 1", source_id="abc123"),
            MockYouTubeShortsRecord(title="", source_id="def456"),  # Invalid - no title
            MockYouTubeShortsRecord(title="Test 3", source_id="ghi789"),
        ]
