...
This folder contains comprehensive documentation for PrismQ.T.Idea.Inspiration.Froms.Content.Shorts.YouTubeShortsSource.

## Available Documentation

### User Guides
- **[Quick Reference Card](QUICK_REFERENCE.md)**: Fast command reference for YouTube scraping (Czech/English)
...
- **[Manual Testing Procedure](MANUAL_TESTING_PROCEDURE.md)**: Step-by-step manual testing guide (Czech/English)
- **[Windows Quickstart Guide](WINDOWS_QUICKSTART.md)**: Step-by-step setup for Windows users
- **[Inspiration Sources](INSPIRATION_SOURCES.md)**: Curated list of YouTube channels for content inspiration
...
### For Users
- [Quick Reference Card](QUICK_REFERENCE.md): Fast command reference
...
- [Manual Testing Procedure](MANUAL_TESTING_PROCEDURE.md): Complete step-by-step manual testing guide
...
- **Questions**: Use [GitHub Discussions](https://github.com/Nomoos/PrismQ.T.Idea.Inspiration.Froms.Content.Shorts.YouTubeShortsSource/discussions)
