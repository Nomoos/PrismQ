...
**Modul / Module**: PrismQ.T.Idea.Inspiration.Froms.Content.Shorts.YouTube  
...
```bash
cd /cesta/k/PrismQ.T.Idea.Inspiration/Froms/Content/Shorts/YouTube
# Windows příklad:
# cd C:\Projects\PrismQ.T.Idea.Inspiration\Froms\Content\Shorts\YouTube
```
