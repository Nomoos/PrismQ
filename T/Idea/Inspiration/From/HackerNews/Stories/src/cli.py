"""Command-line interface for PrismQ.IdeaInspiration.Froms.Content.Forums.HackerNews."""
...
@click.option(
    "--limit", "-l", type=int, default=20, help="Maximum number of records to display (default: 20)"
)
@click.option("--no-interactive", is_flag=True, help="Disable interactive prompts")
...
@click.option("--output", "-o", type=click.Path(), help="Output file for processed ideas (JSON)")
@click.option("--no-interactive", is_flag=True, help="Disable interactive prompts")
