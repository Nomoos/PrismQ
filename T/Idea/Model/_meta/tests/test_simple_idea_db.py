"""Tests for Idea database operations (IdeaTable)."""
...
# Add src/ to path for IdeaTable import
_src_root = str(Path(__file__).resolve().parent.parent.parent.parent.parent.parent / "src")
...
class TestIdeaTableCRUD:
    ...
    def test_insert_idea_from_dict(self):
        ...
        idea = SimpleIdea(text="Create an educational video.", version=2)
...
class TestIdeaTableIntegration:
    ...
    def test_roundtrip_simple_idea(self):
        ...
        # Create SimpleIdea
        original = SimpleIdea(text="Write a story about time travel consequences.", version=1)
