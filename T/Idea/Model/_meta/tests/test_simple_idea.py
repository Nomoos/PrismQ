...
from src.simple_idea import EXAMPLE_IDEAS, IdeaPromptTemplates, SimpleIdea
...
class TestSimpleIdeaSerialization:
    ...
    def test_to_dict(self):
        ...
        idea = SimpleIdea(
            id=1, text="Write a mystery story.", version=2, created_at="2025-01-15T10:00:00"
        )
...
class TestSimpleIdeaVersioning:
    ...
    def test_create_new_version(self):
        ...
        original = SimpleIdea(text="Original idea text", version=1)
...
class TestIdeaPromptTemplates:
    ...
    def test_simple_prompt_template(self):
        ...
        formatted = IdeaPromptTemplates.format_template(
            "simple_prompt", concept="A story about friendship"
        )
...
class TestSimpleIdeaFromTemplate:
    ...
    def test_from_simple_prompt_template(self):
        ...
        idea = SimpleIdea.from_prompt_template(
            "simple_prompt", concept="Create a video about productivity"
        )
