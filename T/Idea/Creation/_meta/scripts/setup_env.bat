@echo off
REM setup_env.bat - Setup Python Virtual Environment for PrismQ.T.Idea.Creation
REM This script creates and activates a virtual environment for the module
REM
REM Virtual environment location: T\Idea\Creation\.venv
...
if not exist "%ENV_FILE%" (
    ...
    echo # PrismQ.T.Idea.Creation Environment Configuration > "%ENV_FILE%"
