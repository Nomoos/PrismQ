...
VARIANT_SHORTFORM = {
    ...
    "example": {
        ...
        "engagement_mechanic": {"type": "question", "content": "Did you know this? Comment below!"},
        "audience_segment": {
            "demographic": "18-34",
...
VARIANT_HOOK_FRAME = {
    ...
    "example": {
        ...
        "title_frame": {"type": "question", "framed_title": "What Really Happened?"},
        "target_audience": "General audience",
...
def get_template(variant_name: str) -> Dict[str, Any]:
    ...
    if variant_name not in VARIANT_TEMPLATES:
        raise KeyError(
            f"Unknown variant: {variant_name}. Available: {list(VARIANT_TEMPLATES.keys())}"
        )
...
def _get_variation_seed(
    title: str, variant_name: str, variation_index: int = 0, use_time: bool = False
) -> int:
...
def pick_multiple_weighted_variants(
...
def create_idea_variant(
    ...
    **kwargs,
    ...
    if variant_name == "emotion_first":
        result.update(
            _create_emotion_first_variant(title, description, kwargs, seed, variation_index)
        )
        ...
        result.update(
            _create_niche_blend_variant(title, description, kwargs, seed, variation_index)
        )
    ...
    # New creative genre-based variants
        ...
        result.update(
            _create_soft_supernatural_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "light_mystery":
        result.update(
            _create_light_mystery_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "scifi_school":
        result.update(
            _create_scifi_school_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "safe_survival":
        result.update(
            _create_safe_survival_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "emotional_drama":
        result.update(
            _create_emotional_drama_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "rivals_allies":
        result.update(
            _create_rivals_allies_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "identity_power":
        result.update(
            _create_identity_power_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "ai_companion":
        result.update(
            _create_ai_companion_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "urban_quest":
        result.update(
            _create_urban_quest_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "magical_aesthetic":
        result.update(
            _create_magical_aesthetic_variant(title, description, kwargs, seed, variation_index)
        )
    # Reddit-style drama variants
    elif variant_name == "family_drama":
        result.update(
            _create_family_drama_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "social_home":
        result.update(
            _create_social_home_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "realistic_mystery":
        result.update(
            _create_realistic_mystery_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "school_family":
        result.update(
            _create_school_family_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "personal_voice":
        result.update(
            _create_personal_voice_variant(title, description, kwargs, seed, variation_index)
        )
    # Story seed variants for US women 13-20
    elif variant_name == "confession_moment":
        result.update(
            _create_confession_moment_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "before_after":
        result.update(
            _create_before_after_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "overheard_truth":
        result.update(
            _create_overheard_truth_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "parallel_lives":
        result.update(
            _create_parallel_lives_variant(title, description, kwargs, seed, variation_index)
        )
        ...
        result.update(
            _create_unsent_message_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "small_moment_big":
        result.update(
            _create_small_moment_big_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "almost_said":
        result.update(
            _create_almost_said_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "what_they_dont_know":
        result.update(
            _create_what_they_dont_know_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "quiet_rebellion":
        result.update(
            _create_quiet_rebellion_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "mirror_moment":
        result.update(
            _create_mirror_moment_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "chosen_family":
        result.update(
            _create_chosen_family_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "growing_apart":
        result.update(
            _create_growing_apart_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "permission_to":
        result.update(
            _create_permission_to_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "learned_young":
        result.update(
            _create_learned_young_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "the_version_of_me":
        result.update(
            _create_the_version_of_me_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "emotional_inheritance":
        result.update(
            _create_emotional_inheritance_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "safe_person":
        result.update(
            _create_safe_person_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "holding_space":
        result.update(
            _create_holding_space_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "rewriting_the_story":
        result.update(
            _create_rewriting_the_story_variant(title, description, kwargs, seed, variation_index)
        )
    # Fusion variants
    elif variant_name == "confession_mystery":
        result.update(
            _create_confession_mystery_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "overheard_transformation":
        result.update(
            _create_overheard_transformation_variant(
                title, description, kwargs, seed, variation_index
            )
        )
    elif variant_name == "unsent_rebellion":
        result.update(
            _create_unsent_rebellion_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "mirror_inheritance":
        result.update(
            _create_mirror_inheritance_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "chosen_growing":
        result.update(
            _create_chosen_growing_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "parallel_permission":
        result.update(
            _create_parallel_permission_variant(title, description, kwargs, seed, variation_index)
        )
    # Missing theme templates
    elif variant_name == "first_butterflies":
        result.update(
            _create_first_butterflies_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "body_acceptance":
        result.update(
            _create_body_acceptance_variant(title, description, kwargs, seed, variation_index)
        )
        ...
        result.update(
            _create_online_connection_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "future_anxiety":
        result.update(
            _create_future_anxiety_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "comparison_trap":
        result.update(
            _create_comparison_trap_variant(title, description, kwargs, seed, variation_index)
        )
    # Blend templates - new themes combined
    elif variant_name == "butterflies_anxiety":
        result.update(
            _create_butterflies_anxiety_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "body_comparison":
        result.update(
            _create_body_comparison_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "online_fitting":
        result.update(
            _create_online_fitting_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "future_comparison":
        result.update(
            _create_future_comparison_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "body_butterflies":
        result.update(
            _create_body_butterflies_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "online_future":
        result.update(
            _create_online_future_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "fitting_comparison":
        result.update(
            _create_fitting_comparison_variant(title, description, kwargs, seed, variation_index)
        )
    # Blend templates - new with older
    elif variant_name == "confession_body":
        result.update(
            _create_confession_body_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "unsent_future":
        result.update(
            _create_unsent_future_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "mirror_body":
        result.update(
            _create_mirror_body_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "growing_online":
        result.update(
            _create_growing_online_variant(title, description, kwargs, seed, variation_index)
        )
        ...
        result.update(
            _create_chosen_online_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "permission_body":
        result.update(
            _create_permission_body_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "small_comparison":
        result.update(
            _create_small_comparison_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "identity_fitting":
        result.update(
            _create_identity_fitting_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "learned_body":
        result.update(
            _create_learned_body_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "safe_online":
        result.update(
            _create_safe_online_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "rewriting_body":
        result.update(
            _create_rewriting_body_variant(title, description, kwargs, seed, variation_index)
        )
    # Family-friendly missing theme templates
    elif variant_name == "fandom_passion":
        result.update(
            _create_fandom_passion_variant(title, description, kwargs, seed, variation_index)
        )
        ...
        result.update(
            _create_imposter_feelings_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "sibling_truth":
        result.update(
            _create_sibling_truth_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "mentor_moment":
        result.update(
            _create_mentor_moment_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "money_reality":
        result.update(
            _create_money_reality_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "heritage_discovery":
        result.update(
            _create_heritage_discovery_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "grief_growth":
        result.update(
            _create_grief_growth_variant(title, description, kwargs, seed, variation_index)
        )
    # Structural blend templates
    elif variant_name == "fandom_skeleton":
        result.update(
            _create_fandom_skeleton_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "imposter_mystery":
        result.update(
            _create_imposter_mystery_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "sibling_emotion_first":
        result.update(
            _create_sibling_emotion_first_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "mentor_hook_frame":
        result.update(
            _create_mentor_hook_frame_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "money_shortform":
        result.update(
            _create_money_shortform_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "heritage_genre":
        result.update(
            _create_heritage_genre_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "grief_scene_seed":
        result.update(
            _create_grief_scene_seed_variant(title, description, kwargs, seed, variation_index)
        )
    elif variant_name == "pet_personal_voice":
        result.update(
            _create_pet_personal_voice_variant(title, description, kwargs, seed, variation_index)
        )
...
def create_ideas_from_input(
    ...
    **kwargs,
    ...
    variant_types = pick_multiple_weighted_variants(
        count, seed, allow_duplicate_types, decay_factor
    )
            ...
            for key, value in variant.items():
                if key not in skip_fields and isinstance(value, str) and value.strip():
                    if value not in used_values and len(value) > MIN_PADDING_FIELD_LENGTH:
                        ...
                        if (
                            len(text) + sum(len(a) for a in additions) + len(additions) * 2
...
def create_idea_text(text_input: str, variant_name: str = None, variation_index: int = 0) -> str:
...
def create_ideas_as_text(
    text_input: str, count: int = DEFAULT_IDEA_COUNT, seed: int = None
) -> List[str]:
...
def create_all_variants(title: str, description: str = "", **kwargs) -> List[Dict[str, Any]]:
...
def create_selected_variants(
    title: str, variant_names: List[str], description: str = "", **kwargs
) -> List[Dict[str, Any]]:
...
def create_multiple_of_same_variant(
    title: str, variant_name: str, count: int = 5, description: str = "", **kwargs
) -> List[Dict[str, Any]]:
    ...
    for i in range(count):
        variant = create_idea_variant(
            title, variant_name, description, variation_index=i, randomize=True, **kwargs
        )
        variants.append(variant)
    return variants
...
def _create_emotion_first_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_mystery_variant(
    ...
    return {
        ...
        "title_direction": {"type": title_type, "suggestion": title_suggestions[title_type]},
...
def _create_skeleton_variant(
    ...
    return {
        ...
        "title_keywords": [
            w for w in _humanize_topic(title).split() if len(w) > MIN_KEYWORD_LENGTH
        ][:MAX_KEYWORDS],
        "title_images": ["Dramatic reveal", "Key visual", "Symbolic image"],
    }


def _create_shortform_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_niche_blend_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
    ...
    if not niches:
        ...
        n3 = _pick_from_pool(
            [n for n in all_niches if n not in [n1, n2]], seed, variation_index + 2
        )
        niches = [n1, n2, n3]
...
def _create_4point_variant(
    ...
    return {
        ...
        "target_audience": kwargs.get("target_audience", "General audience"),
        "style_tone": kwargs.get(
            "style_tone", _pick_from_pool(style_tones, seed, variation_index + 1)
        ),
        "ideal_length": kwargs.get(
            "ideal_length", _pick_from_pool(lengths, seed, variation_index + 2)
        ),
    }


def _create_hook_frame_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
    ...
    return {
        ...
        "title_frame": {"type": frame_type, "framed_title": frame_titles.get(frame_type, topic)},
        "target_audience": kwargs.get("target_audience", "General audience"),
        "suggested_length": kwargs.get(
            "suggested_length", _pick_from_pool(lengths, seed, variation_index + 2)
        ),
    }


def _create_shortform2_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_scene_seed_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_soft_supernatural_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_light_mystery_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_scifi_school_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_safe_survival_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_emotional_drama_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_rivals_allies_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_identity_power_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_ai_companion_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_urban_quest_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_magical_aesthetic_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_family_drama_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
    ...
    return {
        "hook_line": (
            hook
            if topic.lower() in hook.lower()
            else f"{hook} And somehow, {topic.lower()} is at the center of it."
        ),
...
def _create_social_home_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
    ...
    return {
        "digital_trigger": (
            trigger
            if topic.lower() in trigger.lower()
            else f"{trigger} It's connected to {topic.lower()}."
        ),
...
def _create_realistic_mystery_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
    ...
    return {
        "discovery": (
            discovery
            if topic.lower() in discovery.lower()
            else f"{discovery} And it's somehow about {topic.lower()}."
        ),
...
def _create_school_family_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
    ...
    return {
        "collision_point": (
            collision
            if topic.lower() in collision.lower()
            else f"{collision} {topic} made it worse."
        ),
...
def _create_personal_voice_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
    ...
    return {
        "voice_hook": (
            voice_hook
            if topic.lower() in voice_hook.lower()
            else f"{voice_hook} Especially when it comes to {topic.lower()}."
        ),
...
def _create_confession_moment_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_before_after_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_overheard_truth_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_parallel_lives_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_unsent_message_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_small_moment_big_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_almost_said_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_what_they_dont_know_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_quiet_rebellion_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_mirror_moment_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_chosen_family_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_growing_apart_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_permission_to_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_learned_young_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_the_version_of_me_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_emotional_inheritance_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_safe_person_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_holding_space_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_rewriting_the_story_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_confession_mystery_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_overheard_transformation_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
    ...
    return {
        ...
        "immediate_impact": "Something broke and something clicked at the same time",
        "transformation_process": _pick_from_pool(
            transformation_processes, seed, variation_index + 1
        ),
...
def _create_unsent_rebellion_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_mirror_inheritance_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_chosen_growing_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_parallel_permission_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_first_butterflies_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_body_acceptance_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_fitting_in_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_online_connection_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_future_anxiety_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_comparison_trap_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_butterflies_anxiety_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_body_comparison_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_online_fitting_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_future_comparison_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_body_butterflies_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_online_future_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_fitting_comparison_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_confession_body_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_unsent_future_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_mirror_body_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_growing_online_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_quiet_body_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_chosen_online_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_permission_body_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_small_comparison_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_identity_fitting_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_learned_body_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_safe_online_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_rewriting_body_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_fandom_passion_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_imposter_feelings_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_sibling_truth_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_mentor_moment_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_money_reality_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_heritage_discovery_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_grief_growth_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_fandom_skeleton_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_imposter_mystery_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_sibling_emotion_first_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_mentor_hook_frame_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_money_shortform_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_heritage_genre_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_grief_scene_seed_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
...
def _create_pet_personal_voice_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int
) -> Dict[str, Any]:
    ...
    voices = [
        "warm but trying to sound casual",
        "openly affectionate",
        "wryly devoted",
        "quietly grateful",
        "tenderly honest",
...
def _create_triple_blend_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int, blend_type: str
) -> Dict[str, Any]:
...
def _create_double_blend_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int, blend_type: str
) -> Dict[str, Any]:
...
def _create_structural_triple_blend_variant(
    title: str, description: str, kwargs: Dict, seed: int, variation_index: int, blend_type: str
) -> Dict[str, Any]:
