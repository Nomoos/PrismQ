...
Create a template file in `T/Idea/Creation/_meta/prompts/` (e.g., `my_template.txt`):
...
```
Task:
Analyze the following text and identify its core weaknesses in concept, logic, worldbuilding, clarity, or thematic intention. Use these weaknesses to redesign the idea into a stronger, clearer, more compelling version.
...
1. Check the file exists in `T/Idea/Creation/_meta/prompts/`
