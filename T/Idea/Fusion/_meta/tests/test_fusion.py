...
from fusion import FusionConfig, IdeaFusion
...
class TestIdeaFusion:
    ...
    def test_fuse_ideas_preserves_source_ids(self):
        ...
        idea1 = Idea(title="Idea 1", concept="First", inspiration_ids=["source1", "source2"])
        idea2 = Idea(title="Idea 2", concept="Second", inspiration_ids=["source3"])
    ...
    def test_fuse_ideas_with_explicit_title(self):
        ...
        fusion = IdeaFusion()
        fused = fusion.fuse_ideas([idea1, idea2], title="Custom Fused Title")
    ...
    def test_fuse_ideas_with_explicit_concept(self):
        ...
        fusion = IdeaFusion()
        fused = fusion.fuse_ideas([idea1, idea2], concept="Custom fused concept")
    ...
    def test_fuse_respects_max_sources_limit(self):
        ...
        ideas = [
            Idea(title=f"Idea {i}", concept=f"Concept {i}", keywords=[f"kw{i}"]) for i in range(15)
        ]
    ...
    def test_fuse_merges_target_platforms(self):
        ...
        idea1 = Idea(title="Idea 1", concept="First", target_platforms=["youtube", "tiktok"])
        idea2 = Idea(title="Idea 2", concept="Second", target_platforms=["tiktok", "instagram"])
    ...
    def test_fuse_merges_target_formats(self):
        ...
        idea1 = Idea(title="Idea 1", concept="First", target_formats=["text", "audio"])
        idea2 = Idea(title="Idea 2", concept="Second", target_formats=["audio", "video"])
    ...
    def test_fuse_merges_demographics(self):
        ...
        idea1 = Idea(
            title="Idea 1", concept="First", target_demographics={"age": "18-25", "region": "US"}
        )
        idea2 = Idea(
            title="Idea 2",
            concept="Second",
...
class TestBatchFusion:
    ...
    def test_batch_fuse_basic(self):
        ...
        ideas = [Idea(title=f"Idea {i}", concept=f"Concept {i}") for i in range(6)]

        fusion = IdeaFusion()
        fused_ideas = fusion.batch_fuse(source_pool=ideas, num_outputs=2, fusion_size=3)
    ...
    def test_batch_fuse_with_small_pool_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Source pool size"):
            fusion.batch_fuse(
                source_pool=ideas, num_outputs=2, fusion_size=3  # Requires at least 3 sources
            )

    def test_batch_fuse_creates_different_combinations(self):
        """Test that batch fusion creates different combinations."""
        ideas = [
            Idea(title=f"Idea {i}", concept=f"Concept {i}", keywords=[f"kw{i}"]) for i in range(9)
        ]

        fusion = IdeaFusion()
        fused_ideas = fusion.batch_fuse(source_pool=ideas, num_outputs=3, fusion_size=3)
...
class TestFusionStrategies:
    ...
    def test_theme_based_strategy(self):
        ...
        idea1 = Idea(title="Idea 1", concept="First", themes=["innovation", "technology", "future"])
        idea2 = Idea(title="Idea 2", concept="Second", themes=["innovation", "science", "future"])
        idea3 = Idea(title="Idea 3", concept="Third", themes=["innovation", "future", "progress"])
    ...
    def test_keyword_cluster_strategy(self):
        ...
        idea1 = Idea(title="Idea 1", concept="First", keywords=["ai", "tech", "innovation"])
        idea2 = Idea(title="Idea 2", concept="Second", keywords=["ai", "tech", "future"])
        idea3 = Idea(title="Idea 3", concept="Third", keywords=["ai", "science"])
