"""AI configuration for content generation (PrismQ.T.Content level).

This module provides AI configuration for content generation using Ollama.
It belongs at the T/Content level because:
- AI is used for content processing/generation
- Not all PrismQ modules need AI (e.g., database utilities, config)
- This is content-specific, not a cross-cutting concern

According to module hierarchy:
- src/PrismQ: Cross-cutting functionality (database, environment)
- T/PrismQ.T: General content utilities
- T/Content/PrismQ.T.Content: Content processing (AI generation belongs here)
...
# =============================================================================
# Constants - Content-level AI configuration
# =============================================================================
...
@dataclass
class AISettings:
    """AI configuration settings for content generation.
    
    This is at the T/Content level because AI is specifically for
    content processing, not a cross-cutting concern for all PrismQ modules.
    """
...
def create_ai_config(
    ...
    """Factory function to create AI configuration for content generation.
    ...
    Returns:
        Configured AISettings instance
