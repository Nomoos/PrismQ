...
def main():
    ...
    variants = [
        TitleVariant(
            variant_id="A", title="How AI is Transforming Healthcare in 2025", traffic_percent=50
        ),
        TitleVariant(
            variant_id="B", title="AI Healthcare Revolution: 2025 Breakthrough", traffic_percent=50
        ),
    ]
    ...
    metrics_data = {
        "A": VariantMetrics(variant_id="A", views=2618, clicks=285, engagement_score=0.72),
        "B": VariantMetrics(variant_id="B", views=2622, clicks=354, engagement_score=0.81),
    }
