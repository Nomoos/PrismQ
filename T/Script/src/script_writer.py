...
class ScriptWriter:
    ...
    def should_continue_iteration(self) -> bool:
        ...
        if len(self.score_progression) >= 2:
            recent_improvement = self.score_progression[-1] - self.score_progression[-2]
    ...
    def get_version_comparison(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "summary": {
                ...
                "first_version": {"score": first["score"], "created_at": first["created_at"]},
                "latest_version": {"score": latest["score"], "created_at": latest["created_at"]},
            },
        }
    ...
    def _determine_strategy(self, review: Any) -> OptimizationStrategy:
        ...
        if review.category_scores:
            weak_categories = [cs for cs in review.category_scores if cs.score < 70]
            if weak_categories:
