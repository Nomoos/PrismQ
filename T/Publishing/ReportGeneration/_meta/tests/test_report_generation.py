...
def sample_workflow_data():
    ...
    return {
        ...
        "final_scores": {"grammar": 92, "content": 88, "consistency": 90},
        "reviews_history": [
...
class TestReportGeneration:
    ...
    def test_generate_basic_report(self, temp_dir):
        ...
        generator = ReportGenerator(output_dir=temp_dir)
        report = generator.generate_report(content_id="test-001", title="Test Story")
    ...
    def test_generate_report_with_workflow_data(self, temp_dir, sample_workflow_data):
        ...
        report = generator.generate_report(
            content_id="test-001", title="Test Story", workflow_data=sample_workflow_data
        )
    ...
    def test_generate_report_with_export_result(self, temp_dir, sample_export_result):
        ...
        generator = ReportGenerator(output_dir=temp_dir)
        report = generator.generate_report(
            content_id="test-001", title="Test Story", export_result=sample_export_result
        )
...
class TestSummaryGeneration:
    ...
    def test_summary_includes_versions(self, temp_dir):
        ...
        report = generator.generate_report("test-001", "Test Story", workflow_data=workflow_data)
...
class TestTextReportSaving:
    ...
    def test_text_report_structure(self, temp_dir, sample_workflow_data):
        ...
        generator = ReportGenerator(output_dir=temp_dir)
        report = generator.generate_report(
            "test-001", "Test Story", workflow_data=sample_workflow_data
        )
...
class TestMarkdownReportSaving:
    ...
    def test_save_markdown_report(self, temp_dir):
        ...
        generator = ReportGenerator(output_dir=temp_dir)
        report = PublishingReport(content_id="test-001", title="Test Story", total_versions=3)
...
class TestConvenienceFunction:
    ...
    def test_convenience_function_basic(self, temp_dir):
        ...
        report = generate_publishing_report("test-001", "Test Story", output_dir=temp_dir)
    ...
    def test_convenience_function_with_save(self, temp_dir):
        ...
        report = generate_publishing_report(
            "test-001", "Test Story", output_dir=temp_dir, save_format="json"
        )
    ...
    def test_convenience_function_complete(
        self, temp_dir, sample_workflow_data, sample_export_result
    ):
