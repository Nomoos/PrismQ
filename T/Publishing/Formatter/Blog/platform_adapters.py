...
"""
            ...
            optimized_text = optimized_text.replace(
                "[Featured Image]", '{{< figure src="/images/featured.jpg" alt="Featured Image" >}}'
            )
...
class PlatformAdapterFactory:
    ...
    _adapters = {"medium": MediumAdapter, "wordpress": WordPressAdapter, "ghost": GhostAdapter}
    ...
    def optimize_for_platform(
        cls, content: BlogFormattedContent, platform: str
...
def export_for_platform(
    ...
    content = formatter.format_blog(script, title, content_id, platform, format_type, cta_text)
