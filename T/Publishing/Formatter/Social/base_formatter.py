...
class BaseSocialFormatter:
    ...
    def _extract_key_points(self, script: str, max_points: int = 3) -> List[str]:
        ...
        for sentence in sentences:
            ...
            if (
                re.search(r"\d+%|\d+x|result|impact|improve|transform|achieve", sentence.lower())
    ...
    def _extract_hashtags(
        self, script: str, min_hashtags: int = 3, max_hashtags: int = 5
    ) -> List[str]:
    ...
    def _truncate_to_limit(self, text: str, char_limit: int, suffix: str = "...") -> str:
    ...
    def _validate_character_limit(self, text: str, limit: int, platform: str) -> bool:
