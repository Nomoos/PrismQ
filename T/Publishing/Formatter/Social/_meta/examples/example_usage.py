...
def example_1_twitter_basic():
    ...
    result = format_twitter_thread(script=SAMPLE_SCRIPT, content_id="twitter-001")
...
def example_3_linkedin_basic():
    ...
    result = format_linkedin_post(script=SAMPLE_SCRIPT, content_id="linkedin-001")
...
def example_5_instagram_basic():
    ...
    result = format_instagram_caption(script=SAMPLE_SCRIPT, content_id="instagram-001")
...
def example_7_facebook_basic():
    ...
    result = format_facebook_post(script=SAMPLE_SCRIPT, content_id="facebook-001")
...
def example_11_using_formatter_classes():
    ...
    twitter_result = twitter_formatter.format_twitter_thread(
        script=SAMPLE_SCRIPT, content_id="class-twitter-001", hook_type="statement"
    )

    linkedin_result = linkedin_formatter.format_linkedin_post(
        script=SAMPLE_SCRIPT, content_id="class-linkedin-001"
    )
...
def example_12_error_handling():
    ...
    result_special = format_instagram_caption(script="Test with @#$%^&*()", content_id="error-003")
...
def example_13_metadata_analysis():
    ...
    for platform, result in platforms.items():
        if result.success:
            ...
            print(
                f"{platform:<12} {m.character_count:<8} {m.word_count:<8} "
