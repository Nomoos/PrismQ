...
class TestSocialMediaMetadata:
    ...
    def test_metadata_creation(self):
        ...
        metadata = SocialMediaMetadata(platform="twitter", character_count=280, word_count=50)
...
class TestSocialMediaContent:
    ...
    def test_content_to_dict(self):
        ...
        content = SocialMediaContent(
            content_id="test-002", platform="facebook", formatted_content="Test", metadata=metadata
        )
...
class TestTwitterFormatter:
    ...
    def test_format_twitter_thread_basic(self):
        ...
        result = format_twitter_thread(script=SAMPLE_SCRIPT_SHORT, content_id="twitter-001")
    ...
    def test_twitter_character_limit(self):
        ...
        result = format_twitter_thread(script=SAMPLE_SCRIPT_MEDIUM, content_id="twitter-002")
    ...
    def test_twitter_thread_numbering(self):
        ...
        result = format_twitter_thread(script=SAMPLE_SCRIPT_MEDIUM, content_id="twitter-003")
    ...
    def test_twitter_with_emojis(self):
        ...
        result = format_twitter_thread(
            script=SAMPLE_SCRIPT_SHORT, content_id="twitter-005", add_emojis=True
        )
    ...
    def test_twitter_metadata(self):
        ...
        result = format_twitter_thread(script=SAMPLE_SCRIPT_SHORT, content_id="twitter-006")
...
class TestLinkedInFormatter:
    ...
    def test_format_linkedin_post_basic(self):
        ...
        result = format_linkedin_post(script=SAMPLE_SCRIPT_SHORT, content_id="linkedin-001")
        assert result.success is True
    ...
    def test_linkedin_character_limit(self):
        ...
        result = format_linkedin_post(script=SAMPLE_SCRIPT_LONG, content_id="linkedin-002")
        assert len(result.formatted_content) <= 3000

    def test_linkedin_preview_optimization(self):
        """Test LinkedIn preview (first 140 chars)."""
        result = format_linkedin_post(script=SAMPLE_SCRIPT_SHORT, content_id="linkedin-003")
    ...
    def test_linkedin_with_hashtags(self):
        ...
        result = format_linkedin_post(
            script=SAMPLE_SCRIPT_SHORT, content_id="linkedin-004", add_hashtags=True, num_hashtags=5
        )
    ...
    def test_linkedin_structure(self):
        ...
        result = format_linkedin_post(script=SAMPLE_SCRIPT_MEDIUM, content_id="linkedin-005")
    ...
    def test_linkedin_metadata(self):
        ...
        result = format_linkedin_post(script=SAMPLE_SCRIPT_SHORT, content_id="linkedin-006")
...
class TestInstagramFormatter:
    ...
    def test_format_instagram_caption_basic(self):
        ...
        result = format_instagram_caption(script=SAMPLE_SCRIPT_SHORT, content_id="instagram-001")
        assert result.success is True
    ...
    def test_instagram_character_limit(self):
        ...
        result = format_instagram_caption(script=SAMPLE_SCRIPT_LONG, content_id="instagram-002")
        assert len(result.formatted_content) <= 2200

    def test_instagram_preview(self):
        """Test Instagram preview optimization."""
        result = format_instagram_caption(script=SAMPLE_SCRIPT_SHORT, content_id="instagram-003")
    ...
    def test_instagram_separator(self):
        ...
        result = format_instagram_caption(script=SAMPLE_SCRIPT_MEDIUM, content_id="instagram-004")
    ...
    def test_instagram_with_emojis(self):
        ...
        result = format_instagram_caption(
            script=SAMPLE_SCRIPT_SHORT, content_id="instagram-006", add_emojis=True
        )
        # Should have emojis
        assert any(ord(char) > 127 for char in result.formatted_content)
    ...
    def test_instagram_metadata(self):
        ...
        result = format_instagram_caption(script=SAMPLE_SCRIPT_SHORT, content_id="instagram-007")
...
class TestFacebookFormatter:
    ...
    def test_format_facebook_post_basic(self):
        ...
        result = format_facebook_post(script=SAMPLE_SCRIPT_SHORT, content_id="facebook-001")
        assert result.success is True
    ...
    def test_facebook_practical_limit(self):
        ...
        result = format_facebook_post(script=SAMPLE_SCRIPT_LONG, content_id="facebook-002")
    ...
    def test_facebook_preview_optimization(self):
        ...
        result = format_facebook_post(
            script=SAMPLE_SCRIPT_SHORT, content_id="facebook-003", optimize_preview=True
        )
    ...
    def test_facebook_with_engagement_question(self):
        ...
        result = format_facebook_post(
            script=SAMPLE_SCRIPT_SHORT, content_id="facebook-004", add_engagement_question=True
        )
    ...
    def test_facebook_structure(self):
        ...
        result = format_facebook_post(script=SAMPLE_SCRIPT_MEDIUM, content_id="facebook-005")
        # Should have paragraph breaks
        assert "\n\n" in result.formatted_content

    def test_facebook_metadata(self):
        """Test Facebook metadata."""
        result = format_facebook_post(script=SAMPLE_SCRIPT_SHORT, content_id="facebook-006")
...
class TestPlatformSpecificFeatures:
    ...
    def test_linkedin_bullet_formatting(self):
        ...
        result = format_linkedin_post(script=SAMPLE_SCRIPT_MEDIUM, content_id="linkedin-bullets")
    ...
    def test_instagram_engagement_prompts(self):
        ...
        assert any(
            word in result.formatted_content.lower() for word in ["comment", "tag", "share", "save"]
        )
...
class TestMultipleVariants:
    ...
    def test_twitter_different_hooks(self):
        ...
        for hook_type in ["question", "statement", "stat"]:
            result = format_twitter_thread(
                script=SAMPLE_SCRIPT_SHORT, content_id=f"variant-{hook_type}", hook_type=hook_type
            )
