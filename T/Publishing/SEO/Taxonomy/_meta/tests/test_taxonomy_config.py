...
class TestTaxonomyConfig:
    ...
    def test_create_config(self):
        ...
        config = TaxonomyConfig(
            categories={"Tech": ["AI", "Web"]}, min_relevance=0.8, max_tags=5, max_categories=2
        )
    ...
    def test_to_dict(self):
        ...
        config = TaxonomyConfig(categories={"Tech": ["AI"]}, min_relevance=0.75)
    ...
    def test_get_all_categories(self):
        ...
        config = TaxonomyConfig(categories={"Tech": ["AI", "Web"], "Business": ["Marketing"]})
    ...
    def test_validate_invalid_min_relevance(self):
        ...
        config = TaxonomyConfig(categories={"Tech": []}, min_relevance=1.5)  # Invalid
    ...
    def test_validate_invalid_max_tags(self):
        ...
        config = TaxonomyConfig(categories={"Tech": []}, max_tags=0)  # Invalid
    ...
    def test_validate_invalid_max_categories(self):
        ...
        config = TaxonomyConfig(categories={"Tech": []}, max_categories=-1)  # Invalid
...
class TestCreateCustomTaxonomy:
    ...
    def test_create_taxonomy_validation(self):
        ...
        with pytest.raises(ValueError):
            create_custom_taxonomy(categories={}, min_relevance=0.7)  # Empty categories

    def test_create_taxonomy_defaults(self):
        """Test default values in custom taxonomy."""
        config = create_custom_taxonomy(categories={"Test": []})
...
class TestTaxonomyConfigIntegration:
    ...
    def test_config_with_tag_generator(self):
        ...
        config = TaxonomyConfig(categories={"Tech": ["AI"]}, max_tags=5, min_relevance=0.75)
    ...
    def test_config_with_category_classifier(self):
        ...
        config = TaxonomyConfig(categories={"Tech": ["AI"]}, max_categories=2)
...
class TestEdgeCases:
    ...
    def test_deeply_nested_categories(self):
        ...
        config = TaxonomyConfig(categories={"Parent": ["Child1", "Child2"]})
    ...
    def test_large_number_of_categories(self):
        ...
        categories = {f"Category{i}": [f"Sub{j}" for j in range(5)] for i in range(20)}
    ...
    def test_unicode_categories(self):
        ...
        config = TaxonomyConfig(categories={"Technologie": ["IA", "Web"]})
