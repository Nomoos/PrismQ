...
class TestTagGenerationResult:
    ...
    def test_result_to_dict(self):
        ...
        result = TagGenerationResult(tags=["test"], relevance_scores={"test": 0.8})
    ...
    def test_result_repr(self):
        ...
        result = TagGenerationResult(tags=["a", "b", "c"], duplicates_removed=2)
...
class TestTagGenerator:
    ...
    def test_generator_initialization(self):
        ...
        custom_config = TaxonomyConfig(categories={"Test": ["Sub1"]}, max_tags=5)
    ...
    def test_generate_tags_without_keywords(self, sample_content):
        ...
        generator = TagGenerator()
        result = generator.generate_tags(
            title=sample_content["title"], script=sample_content["script"], base_keywords=None
        )
    ...
    def test_max_tags_limit(self):
        ...
        config = TaxonomyConfig(categories={"Test": []}, max_tags=5)
...
class TestGenerateTagsFunction:
    ...
    def test_generate_tags_with_custom_config(self):
        ...
        config = TaxonomyConfig(categories={"Tech": []}, min_relevance=0.8, max_tags=3)
...
class TestEdgeCases:
    ...
    def test_empty_content(self):
        ...
        generator = TagGenerator()
        result = generator.generate_tags(title="", script="", base_keywords=None)
    ...
    def test_short_content(self):
        ...
        generator = TagGenerator()
        result = generator.generate_tags(
            title="AI", script="Artificial Intelligence", base_keywords=["ai"]
        )
