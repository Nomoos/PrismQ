...
from T.Publishing.SEO.Taxonomy.taxonomy_config import DEFAULT_TAXONOMY, TaxonomyConfig
...
class TestCategoryClassificationResult:
    ...
    def test_create_result(self):
        ...
        result = CategoryClassificationResult(
            ...
            confidence_scores={"Technology/Web Development": 0.85, "Technology": 0.75},
    ...
    def test_result_to_dict(self):
        ...
        result = CategoryClassificationResult(
            categories=["Technology"], confidence_scores={"Technology": 0.8}
        )
    ...
    def test_result_repr(self):
        ...
        result = CategoryClassificationResult(categories=["Tech", "Business"])
...
class TestCategoryClassifier:
    ...
    def test_classifier_initialization(self):
        ...
        custom_config = TaxonomyConfig(categories={"Test": ["Sub1"]}, max_categories=2)
    ...
    def test_classify_tech_content(self, tech_content):
        ...
        result = classifier.classify_categories(
            title=tech_content["title"], script=tech_content["script"], tags=tech_content["tags"]
        )
    ...
    def test_classify_ai_content(self, ai_content):
        ...
        classifier = CategoryClassifier()
        result = classifier.classify_categories(
            title=ai_content["title"], script=ai_content["script"], tags=ai_content["tags"]
        )
    ...
    def test_classify_without_tags(self, tech_content):
        ...
        classifier = CategoryClassifier()
        result = classifier.classify_categories(
            title=tech_content["title"], script=tech_content["script"], tags=None
        )
    ...
    def test_hierarchical_categories(self, tech_content):
        ...
        classifier = CategoryClassifier(
            config=TaxonomyConfig(
                categories={"Technology": ["Web Development", "AI", "Mobile"]},
    ...
    def test_hierarchy_building(self):
        ...
        categories = ["Technology", "Technology/Web Development", "Technology/AI", "Business"]
    ...
    def test_get_category_suggestions(self, tech_content):
        ...
        suggestions = classifier.get_category_suggestions(
            title=tech_content["title"], script=tech_content["script"], min_confidence=0.5
        )
...
class TestClassifyCategoriesFunction:
    ...
    def test_classify_with_custom_config(self):
        ...
        config = TaxonomyConfig(categories={"Tech": ["Web"], "Business": []}, max_categories=1)
...
class TestEdgeCases:
    ...
    def test_empty_content(self):
        ...
        classifier = CategoryClassifier()
        result = classifier.classify_categories(title="", script="", tags=None)
    ...
    def test_short_content(self):
        ...
        classifier = CategoryClassifier()
        result = classifier.classify_categories(
            title="AI", script="Artificial Intelligence", tags=["ai"]
        )
