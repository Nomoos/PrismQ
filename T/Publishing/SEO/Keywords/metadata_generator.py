...
class MetadataGenerator:
    ...
    def __init__(self, brand_name: Optional[str] = None, include_brand: bool = True):
    ...
    def generate_metadata(
        ...
        metadata.meta_description = self._generate_meta_description(title, script, primary_keywords)
        ...
        metadata.og_description = self._generate_og_description(metadata.meta_description, script)
    ...
    def _generate_meta_description(
        self, title: str, script: str, primary_keywords: List[str]
    ) -> str:
    ...
    def _generate_title_tag(self, title: str, primary_keywords: List[str]) -> str:
    ...
    def _generate_og_description(self, meta_description: str, script: str) -> str:
    ...
    def _generate_recommendations(
        self, metadata: SEOMetadata, title: str, script: str
    ) -> List[str]:
...
def generate_seo_metadata(
    ...
    return generator.generate_metadata(
        title, script, primary_keywords, secondary_keywords, keyword_density, related_keywords
    )
