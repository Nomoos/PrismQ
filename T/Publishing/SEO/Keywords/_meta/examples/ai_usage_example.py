...
def example_3_custom_ai_config():
    ...
    custom_config = AIConfig(
        model="llama3.1:70b-q4_K_M",  # Specific model
...
def main():
    ...
    print("2. Pull a model: ollama pull llama3.1:70b-q4_K_M")
