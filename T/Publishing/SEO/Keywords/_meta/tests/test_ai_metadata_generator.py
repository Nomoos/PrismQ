...
class TestAIConfig:
    ...
    def test_custom_config(self):
        ...
        config = AIConfig(model="llama3.1:8b", temperature=0.5, enable_ai=False)
...
class TestAIMetadataGenerator:
    ...
    def test_fallback_title_tag(self, generator, sample_content):
        ...
        title_tag = generator._fallback_title_tag(
            title=sample_content["title"], keywords=sample_content["primary_keywords"]
        )
    ...
    def test_generate_title_tag_raises_when_unavailable(self, generator, sample_content):
        ...
        with pytest.raises(AIUnavailableError):
            generator.generate_title_tag(
                title=sample_content["title"], primary_keywords=sample_content["primary_keywords"]
            )
...
class TestAIRecommendations:
    ...
    def test_recommendations_short_description(self):
        ...
        metadata = SEOMetadata(meta_description="Too short", title_tag="Good Title | Brand")
    ...
    def test_recommendations_long_title(self):
        ...
        metadata = SEOMetadata(meta_description="A" * 155, title_tag="A" * 70)  # Too long
    ...
    def test_recommendations_perfect(self):
        ...
        metadata = SEOMetadata(meta_description="A" * 155, title_tag="Perfect Title | Brand")
