...
class TestProcessContentSEO:
    ...
    def test_process_content_basic(self, sample_content):
        ...
        result = process_content_seo(title=sample_content["title"], script=sample_content["script"])
    ...
    def test_process_content_related_keywords(self, sample_content):
        ...
        result = process_content_seo(
            title=sample_content["title"], script=sample_content["script"], include_related=True
        )
    ...
    def test_process_content_without_related(self, sample_content):
        ...
        result = process_content_seo(
            title=sample_content["title"], script=sample_content["script"], include_related=False
        )
...
class TestEdgeCases:
    ...
    def test_empty_content(self):
        ...
        result = process_content_seo(title="", script="")
    ...
    def test_minimal_content(self):
        ...
        result = process_content_seo(title="Test", script="Test.")
