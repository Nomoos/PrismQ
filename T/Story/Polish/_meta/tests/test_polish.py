...
class TestStoryPolisher:
    ...
    def test_polish_title_capitalization(self):
        ...
        polished, changes = polisher._polish_title(
            "The House That Remembers: and Hunts", suggestions, None, None
        )
    ...
    def test_polish_story_no_applicable_suggestions(self):
        ...
        review_data = {
            "overall_assessment": {"quality_score": 95},
            "improvement_suggestions": [
                {"component": "title", "priority": "low", "suggestion": "Minor tweak"}
            ],
        }
...
class TestStoryPolisherIntegration:
    ...
    def test_multiple_iteration_tracking(self):
        ...
        review_data = {
            ...
            "improvement_suggestions": [
                {"component": "title", "priority": "high", "suggestion": 'Capitalize "and"'}
            ],
        }
    ...
    def test_json_serialization_roundtrip(self):
        ...
        review_data = {
            ...
            "improvement_suggestions": [
                {"component": "script", "priority": "high", "suggestion": "Add opening context"}
            ],
        }
...
def test_convenience_function_polish_story_with_gpt():
    ...
    review_data = {
        "overall_assessment": {"quality_score": 90},
        "improvement_suggestions": [
            {"component": "title", "priority": "high", "suggestion": "Test suggestion"}
        ],
    }
