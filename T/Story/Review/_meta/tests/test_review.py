...
class TestExpertReviewBasic:
    ...
    def test_create_review_with_assessment(self):
        ...
        assessment = OverallAssessment(ready_for_publishing=True, quality_score=96, confidence=95)
...
class TestAssessmentComponents:
    ...
    def test_overall_assessment(self):
        ...
        assessment = OverallAssessment(ready_for_publishing=True, quality_score=95, confidence=90)
    ...
    def test_professional_quality(self):
        ...
        quality = ProfessionalQuality(score=90, feedback="Production ready", production_ready=True)
    ...
    def test_platform_optimization(self):
        ...
        optimization = PlatformOptimization(
            score=94, feedback="Perfect for platform", platform_perfect=True
        )
...
class TestExpertReviewMethods:
    ...
    def test_to_dict(self):
        ...
        review = ExpertReview(
            story_id="story-001", story_version="v3", title="Test Title", script="Test script"
        )

        review.overall_assessment = OverallAssessment(
            ready_for_publishing=True, quality_score=95, confidence=90
        )
    ...
    def test_to_json(self):
        ...
        review = ExpertReview(story_id="story-001", story_version="v3", title="Test", script="Test")
...
class TestStoryExpertReviewer:
    ...
    def test_create_reviewer(self):
        ...
        reviewer = StoryExpertReviewer(model="gpt-4", publish_threshold=95)
    ...
    def test_review_includes_all_assessment_dimensions(self):
        ...
        review = reviewer.review_story(
            title="Test", script="Test script", audience_context={}, story_id="test-003"
        )
...
class TestConvenienceFunctions:
    ...
    def test_review_story_to_json(self):
        ...
        json_result = review_story_to_json(
            title="Test Title", script="Test script", audience_context={}, story_id="json-001"
        )
    ...
    def test_get_expert_feedback(self):
        ...
        review = review_story_with_gpt(
            title="Test", script="Test", audience_context={}, story_id="feedback-001"
        )
    ...
    def test_feedback_includes_next_action(self):
        ...
        review = review_story_with_gpt(
            title="Test", script="Test", audience_context={}, story_id="action-001"
        )
