...
class TestYouTubeVideoWorkerInitialization:
    ...
    def test_worker_initializes_correctly(
        ...
        with patch('src.workers.youtube_video_worker.build') as mock_build, \
             patch('src.workers.youtube_video_worker.IdeaInspirationDatabase'):
    ...
    def test_worker_requires_api_key(
        self, temp_queue_db, temp_results_db, temp_idea_db
    ):
...
class TestYouTubeVideoWorkerTaskProcessing:
    ...
    def test_process_single_video_task(
        ...
        with patch('src.workers.youtube_video_worker.build', return_value=mock_youtube), \
             patch('src.workers.youtube_video_worker.IdeaInspirationDatabase') as mock_db_class:
    ...
    def test_unknown_task_type(
        ...
        with patch('src.workers.youtube_video_worker.build'), \
             patch('src.workers.youtube_video_worker.IdeaInspirationDatabase'):
