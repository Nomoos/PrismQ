...
class YouTubeScraper:
    ...
    def scrape(self, url: str) -> List[Video]:
        ...
        return [
            Video(id="yt-1", title="Python Tutorial", url=url, platform="youtube")
        ]
...
class TikTokScraper:
    ...
    def scrape(self, url: str) -> List[Video]:
        ...
        return [
            Video(id="tt-1", title="Dance Video", url=url, platform="tiktok")
        ]
...
class TitleLengthFilter(VideoFilter):
    ...
    def filter(self, videos: List[Video]) -> List[Video]:
        ...
        return [
            v for v in videos 
            if self._min_length <= len(v.title) <= self._max_length
        ]
...
def demonstrate_ocp():
    ...
    chain = FilterChain([
        ...
        TitleLengthFilter(min_length=10, max_length=50)
    ])
