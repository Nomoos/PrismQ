...
class TestIdeaDatabaseScore:
    ...
    def test_insert_idea_with_score(self):
        ...
        idea_id = self.db.insert_idea(text="High quality idea", version=1, score=85)
    ...
    def test_insert_idea_without_score(self):
        ...
        idea_id = self.db.insert_idea(text="Unscored idea", version=1)
    ...
    def test_insert_idea_from_dict_with_score(self):
        ...
        idea_dict = {"text": "Test idea with score", "version": 1, "score": 75}
