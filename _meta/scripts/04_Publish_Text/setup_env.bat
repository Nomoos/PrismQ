@echo off
REM setup_env.bat - Setup Python Virtual Environment for PrismQ Publish Text Modules
REM This script provides environment setup for Text Publishing modules
REM
...
echo.
echo [INFO] Publish Text module environment ready
echo.
