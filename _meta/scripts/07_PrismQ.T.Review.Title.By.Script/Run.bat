@echo off
REM Run.bat - PrismQ.T.Review.Title.By.Script
REM Review title against script - saves to database
REM
REM Usage: Run.bat
...
echo ========================================
echo PrismQ.T.Review.Title.By.Script - RUN MODE
echo ========================================
echo.

python ..\..\..\T\Review\Title\From\Content\src\review_title_from_script_interactive.py
...
set MODULE_DIR=%SCRIPT_DIR%..\..\..\T\Review\Title\From\Content
