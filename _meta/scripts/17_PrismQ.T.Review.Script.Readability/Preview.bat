@echo off
REM Preview.bat - PrismQ.T.Review.Script.Readability
...
echo ========================================
echo PrismQ.T.Review.Script.Readability - PREVIEW MODE
echo ========================================
echo.
echo This mode is for TESTING. Reviews will NOT be saved.
echo.

python ..\..\..\T\Review\Readability\src\review_script_readability_interactive.py --preview --debug
...
set MODULE_DIR=%SCRIPT_DIR%..\..\..\T\Review\Readability
