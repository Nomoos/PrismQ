@echo off
REM Preview.bat - PrismQ.A.Narrator
...
echo ========================================
echo PrismQ.A.Narrator - PREVIEW MODE
echo ========================================
echo.
echo This mode is for TESTING. Selection will NOT be saved.
echo.

python ..\..\..\..\A\Narrator\src\narrator_interactive.py --preview --debug
...
set MODULE_DIR=%SCRIPT_DIR%..\..\..\..\A\Narrator
