@echo off
REM Run.bat - PrismQ.V.Keyframe
REM Keyframe planning and generation - saves to database
REM
REM Usage: Run.bat
...
echo ========================================
echo PrismQ.V.Keyframe - RUN MODE
echo ========================================
echo.

python ..\..\..\V\Keyframe\src\keyframe_interactive.py
...
set MODULE_DIR=%SCRIPT_DIR%..\..\..\V\Keyframe
