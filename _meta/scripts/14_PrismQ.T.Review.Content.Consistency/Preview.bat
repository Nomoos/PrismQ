@echo off
REM Preview.bat - PrismQ.T.Review.Script.Consistency
...
echo ========================================
echo PrismQ.T.Review.Script.Consistency - PREVIEW MODE
echo ========================================
echo.
echo This mode is for TESTING. Reviews will NOT be saved.
echo.

python ..\..\..\T\Review\Consistency\src\review_consistency_interactive.py --preview --debug
...
set MODULE_DIR=%SCRIPT_DIR%..\..\..\T\Review\Consistency
