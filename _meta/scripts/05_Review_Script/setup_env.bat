@echo off
REM setup_env.bat - Setup Python Virtual Environment for PrismQ.T.Review.Script.From.Title

setlocal enabledelayedexpansion

set SCRIPT_DIR=%~dp0
set MODULE_DIR=%SCRIPT_DIR%..\..\..\T\Review\Script\From\Title
...
if not exist "%ENV_FILE%" (
    ...
    echo # PrismQ.T.Review.Script.From.Title Environment Configuration > "%ENV_FILE%"
