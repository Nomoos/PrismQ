@echo off
REM Preview.bat - PrismQ.T.Review.Title.Readability
...
echo ========================================
echo PrismQ.T.Review.Title.Readability - PREVIEW MODE
echo ========================================
echo.
echo This mode is for TESTING. Reviews will NOT be saved.
echo.

python ..\..\..\..\T\Review\Readability\src\review_title_readability_interactive.py --preview --debug
