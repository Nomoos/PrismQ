@echo off
REM Run.bat - PrismQ.T.Review.Script.By.Title.Idea
REM Review script against title and idea - saves to database
REM
REM Usage: Run.bat
...
echo ========================================
echo PrismQ.T.Review.Script.By.Title.Idea - RUN MODE
echo ========================================
echo.

python ..\..\..\T\Review\Content\From\Title\Idea\src\review_script_by_title_idea_interactive.py
...
set MODULE_DIR=%SCRIPT_DIR%..\..\..\T\Review\Content\From\Title\Idea
