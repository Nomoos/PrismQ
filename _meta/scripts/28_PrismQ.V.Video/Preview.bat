@echo off
REM Preview.bat - PrismQ.V.Video
...
echo ========================================
echo PrismQ.V.Video - PREVIEW MODE
echo ========================================
echo.
echo This mode is for TESTING. Videos will NOT be saved.
echo.

python ..\..\..\..\V\Video\src\video_interactive.py --preview --debug
...
set MODULE_DIR=%SCRIPT_DIR%..\..\..\..\V\Video
