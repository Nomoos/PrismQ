#!/bin/bash
# setup_env.sh - Setup Python Virtual Environment for PrismQ.T.Idea.Creation
# This script creates and activates a virtual environment for the module
#
# Virtual environment location: T/Idea/Creation/.venv
...
MODULE_DIR="$(cd "$SCRIPT_DIR/../../../T/Idea/Creation" && pwd)"
