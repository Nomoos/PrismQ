@echo off
REM setup_env.bat - Setup Python Virtual Environment for PrismQ.T.Title.From.Script.Review.Title

setlocal enabledelayedexpansion

set SCRIPT_DIR=%~dp0
set MODULE_DIR=%SCRIPT_DIR%..\..\..\T\Title\From\Title\Review\Script
...
if not exist "%ENV_FILE%" (
    ...
    echo # PrismQ.T.Title.From.Script.Review.Title Environment Configuration > "%ENV_FILE%"
