@echo off
REM setup_env.bat - Setup Python Virtual Environment for PrismQ Video Modules
REM This script provides environment setup for Video modules
REM
...
echo.
echo [INFO] Video module environment ready
echo.
