...
All workflow documentation is now organized in the [`docs/workflow/`](./) directory:

### Core Workflow
- **[State Machine](./state-machine.md)** - Complete state diagram and overview
- **[Workflow Phases](./phases.md)** - The 9 main content production phases
- **[State Transitions](./transitions.md)** - Rules for moving between states
- **[State Characteristics](./states.md)** - Different types of states
- **[Publishing Strategy](./publishing-strategy.md)** - Progressive multi-format approach
- **[Workflow Management](./management.md)** - Operations, quality gates, and best practices
- **[Ultra-Clean Pipeline](./ultra-clean-pipeline.md)** - Simplified execution flow representation
...
1. **Understand the Big Picture**: Start with [State Machine](./state-machine.md)
2. **Learn the Phases**: Read [Workflow Phases](./phases.md)
3. **MVP Implementation**: Check [MVP Overview](./mvp-overview.md)
4. **Integrate**: Use [MVP API Reference](./mvp-api.md)
