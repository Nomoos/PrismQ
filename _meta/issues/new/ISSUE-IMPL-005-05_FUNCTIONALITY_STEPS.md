# PrismQ.T.Review.Title.By.Script.Idea - Basic Functionality Steps

**Module**: `T/Review/Title/From/Script/Idea`  
**Namespace**: `PrismQ.T.Review.Title.By.Script.Idea` (alternative naming)  
**Purpose**: Review title v1 against script v1 and original idea  
**Date**: 2025-12-23
...
1. The script content (Title-Script Alignment)
...
|---|------|-------------|--------|----------|
| 1.1 | Accept title text | Receive title text to review (required) | ✅ IMPLEMENTED | `by_script_and_idea.py:498` |
| 1.2 | Accept script content | Receive full script text (required) | ✅ IMPLEMENTED | `by_script_and_idea.py:498` |
| 1.3 | Accept idea summary | Receive core idea summary (required) | ✅ IMPLEMENTED | `by_script_and_idea.py:498` |
| 1.4 | Accept optional metadata | Accept title_id, content_id, idea_id, etc. | ✅ IMPLEMENTED | `by_script_and_idea.py:498` |
| 1.5 | Generate IDs if missing | Create unique IDs for title/content/idea | ✅ IMPLEMENTED | `by_script_and_idea.py:550-552` |
| 1.6 | Extract script summary | Auto-generate summary if not provided | ✅ IMPLEMENTED | `by_script_and_idea.py:556-560` |
...
| # | Step | Description | Status | Location |
|---|------|-------------|--------|----------|
| 2.1 | Extract title keywords | Extract meaningful keywords from title | ✅ IMPLEMENTED | `by_script_and_idea.py:129-153` |
| 2.2 | Extract script keywords | Extract keywords from script content | ✅ IMPLEMENTED | `by_script_and_idea.py:129-153` |
| 2.3 | Extract idea keywords | Extract keywords from idea summary | ✅ IMPLEMENTED | `by_script_and_idea.py:129-153` |
| 2.4 | Filter stopwords | Remove common words (the, and, or, etc.) | ✅ IMPLEMENTED | `by_script_and_idea.py:39-79` |
| 2.5 | Frequency analysis | Count word frequency for ranking | ✅ IMPLEMENTED | `by_script_and_idea.py:146-149` |
| 2.6 | Sort by relevance | Return top keywords sorted by frequency | ✅ IMPLEMENTED | `by_script_and_idea.py:152-153` |
...
### Phase 3: Title-Script Alignment Analysis

| # | Step | Description | Status | Location |
|---|------|-------------|--------|----------|
| 3.1 | Compare keywords | Match title keywords with script keywords | ✅ IMPLEMENTED | `by_script_and_idea.py:176-180` |
| 3.2 | Calculate match percentage | Determine what % of title keywords appear in script | ✅ IMPLEMENTED | `by_script_and_idea.py:182-186` |
| 3.3 | Identify mismatches | List title keywords NOT in script | ✅ IMPLEMENTED | `by_script_and_idea.py:189` |
| 3.4 | Check script intro | Look for title keywords in first 20% of script | ✅ IMPLEMENTED | `by_script_and_idea.py:199-202` |
| 3.5 | Check script summary | Verify keywords in summary if provided | ✅ IMPLEMENTED | `by_script_and_idea.py:195-196` |
| 3.6 | Calculate alignment score | Score 0-100 based on keyword matching | ✅ IMPLEMENTED | `by_script_and_idea.py:193-205` |
| 3.7 | Generate reasoning | Explain the alignment score | ✅ IMPLEMENTED | `by_script_and_idea.py:208-215` |
...
| # | Step | Description | Status | Location |
|---|------|-------------|--------|----------|
| 4.1 | Compare with idea | Match title keywords with idea keywords | ✅ IMPLEMENTED | `by_script_and_idea.py:245-250` |
| 4.2 | Check intent alignment | Verify keywords match idea intent if provided | ✅ IMPLEMENTED | `by_script_and_idea.py:253-257` |
| 4.3 | Calculate match percentage | Determine keyword overlap with idea | ✅ IMPLEMENTED | `by_script_and_idea.py:259-262` |
| 4.4 | Identify mismatches | List title keywords NOT in idea | ✅ IMPLEMENTED | `by_script_and_idea.py:271` |
| 4.5 | Calculate alignment score | Score 0-100 based on idea alignment | ✅ IMPLEMENTED | `by_script_and_idea.py:265-273` |
| 4.6 | Generate reasoning | Explain the idea alignment score | ✅ IMPLEMENTED | `by_script_and_idea.py:276-283` |
...
| # | Step | Description | Status | Location |
|---|------|-------------|--------|----------|
| 5.1 | Check engagement words | Count curiosity-inducing words (mystery, discover, etc.) | ✅ IMPLEMENTED | `by_script_and_idea.py:306` |
| 5.2 | Check question pattern | Detect questions (how, what, why, when, where) | ✅ IMPLEMENTED | `by_script_and_idea.py:309` |
| 5.3 | Check number pattern | Detect numbers in title | ✅ IMPLEMENTED | `by_script_and_idea.py:310` |
| 5.4 | Check action pattern | Detect action words (guide, tips, ways, etc.) | ✅ IMPLEMENTED | `by_script_and_idea.py:311` |
| 5.5 | Calculate curiosity score | Score based on curiosity-inducing elements | ✅ IMPLEMENTED | `by_script_and_idea.py:314` |
| 5.6 | Calculate clickthrough potential | Estimate CTR based on title appeal | ✅ IMPLEMENTED | `by_script_and_idea.py:315` |
| 5.7 | Calculate engagement score | Overall engagement scoring | ✅ IMPLEMENTED | `by_script_and_idea.py:316` |
| 5.8 | Check expectation accuracy | Detect misleading words (ultimate, best, perfect) | ✅ IMPLEMENTED | `by_script_and_idea.py:319-320` |
...
| # | Step | Description | Status | Location |
|---|------|-------------|--------|----------|
| 6.1 | Check SEO patterns | Look for question/number/action patterns | ✅ IMPLEMENTED | `by_script_and_idea.py:347-349` |
| 6.2 | Calculate keyword relevance | Check title keyword overlap with script | ✅ IMPLEMENTED | `by_script_and_idea.py:352-354` |
| 6.3 | Evaluate title length | Score based on optimal length (50-70 chars) | ✅ IMPLEMENTED | `by_script_and_idea.py:356-363` |
| 6.4 | Calculate SEO score | Overall SEO optimization score | ✅ IMPLEMENTED | `by_script_and_idea.py:366` |
| 6.5 | Suggest keywords | Recommend script keywords not in title | ✅ IMPLEMENTED | `by_script_and_idea.py:369` |
...
| # | Step | Description | Status | Location |
|---|------|-------------|--------|----------|
| 7.1 | Analyze script alignment gaps | Create recommendations for weak script alignment | ✅ IMPLEMENTED | `by_script_and_idea.py:401-423` |
| 7.2 | Analyze idea alignment gaps | Create recommendations for weak idea alignment | ✅ IMPLEMENTED | `by_script_and_idea.py:426-436` |
| 7.3 | Analyze engagement gaps | Create recommendations for low engagement | ✅ IMPLEMENTED | `by_script_and_idea.py:439-449` |
| 7.4 | Analyze clarity issues | Create recommendations for clarity (length, etc.) | ✅ IMPLEMENTED | `by_script_and_idea.py:452-473` |
| 7.5 | Analyze SEO opportunities | Create recommendations for SEO optimization | ✅ IMPLEMENTED | `by_script_and_idea.py:476-490` |
| 7.6 | Prioritize improvements | Sort by impact score (high to low) | ✅ IMPLEMENTED | `by_script_and_idea.py:493` |
...
| # | Step | Description | Status | Location |
|---|------|-------------|--------|----------|
| 8.1 | Calculate overall score | Weighted average of all category scores | ✅ IMPLEMENTED | `by_script_and_idea.py:574-579` |
| 8.2 | Create category scores | Build TitleCategoryScore objects for each category | ✅ IMPLEMENTED | `by_script_and_idea.py:582-655` |
| 8.3 | Collect improvement points | Add all generated improvement recommendations | ✅ IMPLEMENTED | `by_script_and_idea.py:658-660` |
| 8.4 | Determine revision need | Flag if major revision needed (score < 65) | ✅ IMPLEMENTED | `by_script_and_idea.py:663` |
| 8.5 | Build strengths list | Identify what the title does well | ✅ IMPLEMENTED | `by_script_and_idea.py:701-708` |
| 8.6 | Identify primary concern | Highlight the most critical issue | ✅ IMPLEMENTED | `by_script_and_idea.py:710-711` |
| 8.7 | List quick wins | Identify easy high-impact improvements | ✅ IMPLEMENTED | `by_script_and_idea.py:712-714` |
| 8.8 | Create TitleReview object | Build complete review with all data | ✅ IMPLEMENTED | `by_script_and_idea.py:666-716` |
...
| 9.7 | get_alignment_summary() | Get title-script-idea alignment summary | ✅ IMPLEMENTED | `title_review.py:247-279` |
...
| # | Step | Description | Status | Location |
|---|------|-------------|--------|----------|
| 10.1 | Unit tests - keyword extraction | Test keyword extraction functionality | ✅ IMPLEMENTED | `_meta/tests/test_by_script_and_idea.py:28-59` |
| 10.2 | Unit tests - alignment analysis | Test alignment scoring | ✅ IMPLEMENTED | `_meta/tests/test_by_script_and_idea.py:61-130` |
| 10.3 | Unit tests - engagement analysis | Test engagement scoring | ✅ IMPLEMENTED | `_meta/tests/test_by_script_and_idea.py` |
| 10.4 | Unit tests - full review | Test end-to-end review | ✅ IMPLEMENTED | `_meta/tests/test_by_script_and_idea.py` |
...
| 3 | Title-Script Alignment | 7 | 9 | 🟢 78% |
...
2. **Missing Interactive Script** (Phase 11.4)
   - `review_title_by_script_idea_interactive.py` doesn't exist
