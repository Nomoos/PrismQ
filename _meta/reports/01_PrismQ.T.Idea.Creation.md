# Kontrola běhu modulu: PrismQ.T.Idea.Creation
...
- Moduly:
  - `T/Idea/Creation/src/idea_variants.py` - Generování variant
  - `T/Idea/Creation/src/ai_generator.py` - AI generátor
  - `T/Idea/Creation/src/flavor_loader.py` - Načítání flavors
  - `T/Idea/Creation/src/flavors.py` - Definice flavors
