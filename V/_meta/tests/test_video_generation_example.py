...
class TestSubtitleSegment:
    ...
    def test_subtitle_duration_property(self):
        ...
        sub = SubtitleSegment(text="Test", start_time=2.0, end_time=4.5)
...
class TestVideoComposition:
    ...
    def test_validate_overlapping_scenes(self):
        ...
        scenes = [
            ...
            SceneDescription(
                ...
                15.0,
                "kf_001",
                "narration2",  # Overlaps at 8.0-10.0
                CameraMovement.STATIC,
                TransitionType.FADE,
                TransitionType.FADE,
            ),
    ...
    def test_get_subtitles_at_timestamp(self):
        ...
        video = VideoComposition(
            title="Test", duration=10.0, keyframes=[], scenes=[], subtitles=subtitles, metadata={}
        )
